...
!(function (e, d) {
  ...
  "object" == typeof module && "object" == typeof module.exports
    ...
    : d(e);
})("undefined" != typeof window ? window : this, function (e, d) {
  "use strict";
  var t = [],
  ...
  function v(e, d, t) {
    var n,
      i,
      o = (t = t || g).createElement("script");
    if (((o.text = e), d))
      for (n in y)
        (i = d[n] || (d.getAttribute && d.getAttribute(n))) &&
          o.setAttribute(n, i);
  ...
  (S.fn = S.prototype =
    {
      ...
      pushStack: function (e) {
        var d = S.merge(this.constructor(), e);
      ...
      eq: function (e) {
        var d = this.length,
          t = +e + (e < 0 ? d : 0);
        return this.pushStack(t >= 0 && t < d ? [this[t]] : []);
      },
      end: function () {
    ...
    S.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(d = n(e)) ||
            ("function" ==
              typeof (t = c.call(d, "constructor") && d.constructor) &&
              u.call(t) === $))
        );
      },
      ...
      globalEval: function (e, d, t) {
        v(e, { nonce: d && d.nonce }, t);
      },
      each: function (e, d) {
        var t,
          n = 0;
        if (w(e))
          for (t = e.length; n < t && !1 !== d.call(e[n], n, e[n]); n++);
        else for (n in e) if (!1 === d.call(e[n], n, e[n])) break;
        return e;
      },
      ...
      inArray: function (e, d, t) {
        return null == d ? -1 : s.call(d, e, t);
      },
      merge: function (e, d) {
        for (var t = +d.length, n = 0, i = e.length; n < t; n++) e[i++] = d[n];
        return (e.length = i), e;
      },
      grep: function (e, d, t) {
        for (var n = [], i = 0, o = e.length, r = !t; i < o; i++)
          !d(e[i], i) !== r && n.push(e[i]);
        return n;
      },
      map: function (e, d, t) {
        var n,
        ...
        if (w(e))
          for (n = e.length; r < n; r++)
            null != (i = d(e[r], r, t)) && s.push(i);
        else for (r in e) null != (i = d(e[r], r, t)) && s.push(i);
        return o(s);
      },
      guid: 1,
      support: p,
  ...
  var C =
    ...
    (function (e) {
      var d,
        ...
        M = N.slice,
        I = function (e, d) {
          for (var t = 0, n = e.length; t < n; t++) if (e[t] === d) return t;
          return -1;
        },
        H =
      ...
      try {
        D.apply((N = M.call(S.childNodes)), S.childNodes),
          N[S.childNodes.length].nodeType;
      } catch (e) {
        D = {
          apply: N.length
            ? function (e, d) {
            ...
            : function (e, d) {
                for (var t = e.length, n = 0; (e[t++] = d[n++]); );
                e.length = t - 1;
              },
        };
      }
      function se(e, d, n, i) {
        ...
        if (!i && ($(d), (d = d || p), h)) {
          if (11 !== S && (u = Q.exec(e)))
            if ((o = u[1])) {
              if (9 === S) {
                if (!(l = d.getElementById(o))) return n;
              ...
              if (u[2]) return D.apply(n, d.getElementsByTagName(e)), n;
              if (
                (o = u[3]) &&
                t.getElementsByClassName &&
                d.getElementsByClassName
              )
                return D.apply(n, d.getElementsByClassName(o)), n;
            }
          if (
            t.qsa &&
            !E[e + " "] &&
            (!g || !g.test(e)) &&
            (1 !== S || "object" !== d.nodeName.toLowerCase())
          ) {
            if (((y = e), (v = d), 1 === S && (z.test(e) || U.test(e)))) {
              for (
                ((v = (ee.test(e) && ye(d.parentNode)) || d) === d &&
                  t.scope) ||
                  ((c = d.getAttribute("id"))
                    ? (c = c.replace(ne, ie))
                    : d.setAttribute("id", (c = b))),
                  s = (f = r(e)).length;
                s--;

              )
                f[s] = (c ? "#" + c : ":scope") + " " + me(f[s]);
              y = f.join(",");
            }
            try {
              if (
                t.cssSupportsSelector &&
              ...
              c === b && d.removeAttribute("id");
            }
          }
        }
        return a(e.replace(F, "$1"), d, n, i);
      }
      function ae() {
        var e = [];
        return function d(t, i) {
          return (
            e.push(t + " ") > n.cacheLength && delete d[e.shift()],
            (d[t + " "] = i)
          );
        };
      }
      ...
      function ce(e) {
        var d = p.createElement("fieldset");
        try {
          return !!e(d);
        } catch (e) {
          return !1;
      ...
      function ue(e, d) {
        for (var t = e.split("|"), i = t.length; i--; ) n.attrHandle[t[i]] = d;
      }
      function $e(e, d) {
        var t = d && e,
          n =
            ...
            1 === e.nodeType &&
            1 === d.nodeType &&
            e.sourceIndex - d.sourceIndex;
        if (n) return n;
        if (t) for (; (t = t.nextSibling); ) if (t === d) return -1;
        return e ? 1 : -1;
      }
      function pe(e) {
        return function (d) {
          return "input" === d.nodeName.toLowerCase() && d.type === e;
        };
      }
      function fe(e) {
        return function (d) {
          var t = d.nodeName.toLowerCase();
          return ("input" === t || "button" === t) && d.type === e;
        };
      }
      function he(e) {
        return function (d) {
            ...
            ? d.parentNode && !1 === d.disabled
              ? "label" in d
                ? "label" in d.parentNode
                  ? d.parentNode.disabled === e
                  : d.disabled === e
                : d.isDisabled === e || (d.isDisabled !== !e && re(d) === e)
              : d.disabled === e
            : "label" in d && d.disabled === e;
        };
      }
      function ge(e) {
        return le(function (d) {
          return (
            (d = +d),
            le(function (t, n) {
              for (var i, o = e([], t.length, d), r = o.length; r--; )
                t[(i = o[r])] && (t[i] = !(n[i] = t[i]));
            })
          );
        });
      ...
      for (d in ((t = se.support = {}),
      (o = se.isXML =
        function (e) {
          var d = e && e.namespaceURI,
            t = e && (e.ownerDocument || e).documentElement;
          return !Y.test(d || (t && t.nodeName) || "HTML");
        }),
      ($ = se.setDocument =
        function (e) {
          var d,
            i,
            r = e ? e.ownerDocument || e : S;
          return r != p && 9 === r.nodeType && r.documentElement
            ? ((f = (p = r).documentElement),
              ...
              (t.cssSupportsSelector = ce(function () {
                return (
              ...
              (t.getElementsByClassName = J.test(p.getElementsByClassName)),
              (t.getById = ce(function (e) {
                return (
              ...
              t.getById
                ? ((n.filter.ID = function (e) {
                    var d = e.replace(de, te);
                    return function (e) {
                      return e.getAttribute("id") === d;
                    };
                  }),
                  (n.find.ID = function (e, d) {
                    if (void 0 !== d.getElementById && h) {
                ...
                : ((n.filter.ID = function (e) {
                  ...
                  (n.find.ID = function (e, d) {
                    if (void 0 !== d.getElementById && h) {
                      ...
                      if (o) {
                        if ((t = o.getAttributeNode("id")) && t.value === e)
                          return [o];
                        for (i = d.getElementsByName(e), n = 0; (o = i[n++]); )
                          if ((t = o.getAttributeNode("id")) && t.value === e)
                            return [o];
                      }
                      return [];
              ...
              (n.find.TAG = t.getElementsByTagName
                ? function (e, d) {
                    return void 0 !== d.getElementsByTagName
                ...
                : function (e, d) {
                    var t,
                      n = [],
                      i = 0,
                      o = d.getElementsByTagName(e);
                    if ("*" === e) {
                      for (; (t = o[i++]); ) 1 === t.nodeType && n.push(t);
                      return n;
                    }
                    return o;
                  }),
              (n.find.CLASS =
                t.getElementsByClassName &&
                function (e, d) {
                  if (void 0 !== d.getElementsByClassName && h)
                    return d.getElementsByClassName(e);
                }),
              (y = []),
              (g = []),
              (t.qsa = J.test(p.querySelectorAll)) &&
                (ce(function (e) {
                  var d;
                  (f.appendChild(e).innerHTML =
                    ...
                    e.querySelectorAll("[id~=" + b + "-]").length ||
                      g.push("~="),
                    (d = p.createElement("input")).setAttribute("name", ""),
                    e.appendChild(d),
                ...
                ce(function (e) {
                  ...
                  d.setAttribute("type", "hidden"),
                    e.appendChild(d).setAttribute("name", "D"),
              ...
              t.cssSupportsSelector || g.push(":has"),
              (g = g.length && new RegExp(g.join("|"))),
              (y = y.length && new RegExp(y.join("|"))),
              (d = J.test(f.compareDocumentPosition)),
              (m =
                d || J.test(f.contains)
                  ? function (e, d) {
              ...
              (A = d
                ? function (e, d) {
                    if (e === d) return (u = !0), 0;
                    var n =
                      !e.compareDocumentPosition - !d.compareDocumentPosition;
                    return (
                      n ||
                      (1 &
                        (n =
                          (e.ownerDocument || e) == (d.ownerDocument || d)
                            ? e.compareDocumentPosition(d)
                            : 1) ||
                      (!t.sortDetached && d.compareDocumentPosition(e) === n)
                        ? e == p || (e.ownerDocument == S && m(S, e))
                          ? -1
                          : d == p || (d.ownerDocument == S && m(S, d))
                          ? 1
                          : c
                          ? I(c, e) - I(c, d)
                          : 0
                ...
                : function (e, d) {
                    ...
                    for (t = d; (t = t.parentNode); ) s.unshift(t);
                    for (; r[n] === s[n]; ) n++;
                    return n
                      ? $e(r[n], s[n])
                      : r[n] == S
      ...
      (se.matches = function (e, d) {
        return se(e, null, null, d);
      }),
      (se.matchesSelector = function (e, d) {
        if (
          ($(e),
          t.matchesSelector &&
            h &&
        ...
        return se(d, p, null, [e]).length > 0;
      }),
      (se.contains = function (e, d) {
        return (e.ownerDocument || e) != p && $(e), m(e, d);
      }),
      (se.attr = function (e, d) {
        (e.ownerDocument || e) != p && $(e);
        var i = n.attrHandle[d.toLowerCase()],
          o = i && L.call(n.attrHandle, d.toLowerCase()) ? i(e, d, !h) : void 0;
        return void 0 !== o
          ? o
          : t.attributes || !h
          ? e.getAttribute(d)
          : (o = e.getAttributeNode(d)) && o.specified
          ? o.value
          : null;
      }),
      ...
      (n = se.selectors =
        {
          ...
          preFilter: {
            ATTR: function (e) {
              return (
                (e[1] = e[1].replace(de, te)),
                (e[3] = (e[3] || e[4] || e[5] || "").replace(de, te)),
                "~=" === e[2] && (e[3] = " " + e[3] + " "),
                e.slice(0, 4)
              );
            },
              ...
              return V.CHILD.test(e[0])
                ...
                : (e[3]
                    ...
                    : t &&
                      G.test(t) &&
                      (d = r(t, !0)) &&
                      (d = t.indexOf(")", t.length - d) - t.length) &&
                      ((e[0] = e[0].slice(0, d)), (e[2] = t.slice(0, d))),
                  e.slice(0, 3));
            },
          },
          filter: {
            TAG: function (e) {
              var d = e.replace(de, te).toLowerCase();
              return "*" === e
                ? function () {
                    return !0;
                  }
                : function (e) {
                    return e.nodeName && e.nodeName.toLowerCase() === d;
                  };
            },
            CLASS: function (e) {
              var d = T[e + " "];
                ...
                return null == i
                  ...
                  : !d ||
                      ...
                      "=" === d
                        ...
                        ? t && i.indexOf(t) > -1
                        : "$=" === d
                        ? t && i.slice(-t.length) === t
                        : "~=" === d
                        ? (" " + i.replace(B, " ") + " ").indexOf(t) > -1
                        : "|=" === d &&
                          (i === t || i.slice(0, t.length + 1) === t + "-"));
              };
            },
            CHILD: function (e, d, t, n, i) {
              ...
              return 1 === n && 0 === i
                ...
                : function (d, t, a) {
                    var l,
                      ...
                      p,
                      f,
                      h = o !== r ? "nextSibling" : "previousSibling",
                      g = d.parentNode,
                      y = s && d.nodeName.toLowerCase(),
                      v = !a && !s,
                      m = !1;
                    if (g) {
                      if (o) {
              ...
              return i[b]
                ...
                ? ((t = [e, e, "", d]),
                  n.setFilters.hasOwnProperty(e.toLowerCase())
                    ? le(function (e, t) {
                        for (var n, o = i(e, d), r = o.length; r--; )
                          e[(n = I(e, o[r]))] = !(t[n] = o[r]);
                      })
                    : function (e) {
                        return i(e, 0, t);
          ...
          pseudos: {
            not: le(function (e) {
              ...
              return n[b]
                ...
                : function (e, i, o) {
                    return (
                      (d[0] = e), n(d, null, o, t), (d[0] = null), !t.pop()
                    );
                  };
            }),
            has: le(function (e) {
              return function (d) {
                return se(e, d).length > 0;
              };
            }),
            contains: le(function (e) {
              return (
                (e = e.replace(de, te)),
                function (d) {
                  return (d.textContent || i(d)).indexOf(e) > -1;
                }
              );
            }),
            lang: le(function (e) {
                ...
                function (d) {
                  ...
                  do {
                    if (
                      ...
                      return (
                        (t = t.toLowerCase()) === e || 0 === t.indexOf(e + "-")
                      );
            ...
            button: function (e) {
              var d = e.nodeName.toLowerCase();
              return ("input" === d && "button" === e.type) || "button" === d;
            },
            text: function (e) {
              var d;
              return (
            ...
            last: ge(function (e, d) {
              return [d - 1];
            }),
            eq: ge(function (e, d, t) {
              return [t < 0 ? t + d : t];
            }),
            even: ge(function (e, d) {
              for (var t = 0; t < d; t += 2) e.push(t);
              return e;
            }),
            odd: ge(function (e, d) {
              for (var t = 1; t < d; t += 2) e.push(t);
              return e;
            }),
            lt: ge(function (e, d, t) {
              for (var n = t < 0 ? t + d : t > d ? d : t; --n >= 0; ) e.push(n);
              return e;
            }),
            gt: ge(function (e, d, t) {
              for (var n = t < 0 ? t + d : t; ++n < d; ) e.push(n);
              return e;
            }),
          },
        }),
      ...
      { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
        n.pseudos[d] = pe(d);
      for (d in { submit: !0, reset: !0 }) n.pseudos[d] = fe(d);
      function ve() {}
      function me(e) {
        for (var d = 0, t = e.length, n = ""; d < t; d++) n += e[d].value;
        return n;
      }
      function be(e, d, t) {
        var n = d.dir,
        ...
        return d.first
          ? function (d, t, i) {
              for (; (d = d[n]); ) if (1 === d.nodeType || r) return e(d, t, i);
              return !1;
            }
          : function (d, t, a) {
              var l,
              ...
              if (a) {
                for (; (d = d[n]); )
                  if ((1 === d.nodeType || r) && e(d, t, a)) return !0;
              } else
                for (; (d = d[n]); )
                  if (1 === d.nodeType || r)
                    if (
                      ((c =
                        ...
                        (u[d.uniqueID] = {})),
                      i && i === d.nodeName.toLowerCase())
                    )
                      d = d[n] || d;
                    else {
                      if ((l = c[o]) && l[0] === w && l[1] === s)
                        return ($[2] = l[2]);
                      if (((c[o] = $), ($[2] = e(d, t, a)))) return !0;
                    }
              return !1;
            };
      }
      function Se(e) {
        return e.length > 1
          ? function (d, t, n) {
              for (var i = e.length; i--; ) if (!e[i](d, t, n)) return !1;
              return !0;
            }
          : e[0];
      }
      function we(e, d, t, n, i) {
        for (var o, r = [], s = 0, a = e.length, l = null != d; s < a; s++)
          (o = e[s]) && ((t && !t(o, n, i)) || (r.push(o), l && d.push(s)));
        return r;
      }
      function Ce(e, d, t, n, i, o) {
        return (
          n && !n[b] && (n = Ce(n)),
          i && !i[b] && (i = Ce(i, o)),
          le(function (o, r, s, a) {
            var l,
              ...
              h =
                o ||
                (function (e, d, t) {
                  for (var n = 0, i = d.length; n < i; n++) se(e, d[n], t);
                  return t;
                })(d || "*", s.nodeType ? [s] : s, []),
              g = !e || (!o && d) ? h : we(h, $, e, s, a),
              y = t ? (i || (o ? e : f || n) ? [] : r) : g;
            if ((t && t(g, y, s, a), n))
              for (l = we(y, p), n(l, [], s, a), c = l.length; c--; )
                (u = l[c]) && (y[p[c]] = !(g[p[c]] = u));
            if (o) {
              if (i || e) {
                if (i) {
            ...
            } else (y = we(y === r ? y.splice(f, y.length) : y)), i ? i(null, r, y, a) : D.apply(r, y);
          })
        );
      }
      function Te(e) {
        for (
          ...
          if ((t = n.relative[e[a].type])) $ = [be(Se($), t)];
          else {
            if ((t = n.filter[e[a].type].apply(null, e[a].matches))[b]) {
              for (i = ++a; i < o && !n.relative[e[i].type]; i++);
              return Ce(
                a > 1 && Se($),
                a > 1 &&
                  me(
      ...
      return (
        ...
        (r = se.tokenize =
          function (e, d) {
            var t,
              ...
              l,
              c = x[e + " "];
            if (c) return d ? 0 : c.slice(0);
            for (s = e, a = [], l = n.preFilter; s; ) {
              for (r in ((t && !(i = W.exec(s))) ||
                (i && (s = s.slice(i[0].length) || s), a.push((o = []))),
              (t = !1),
              (i = U.exec(s)) &&
                ((t = i.shift()),
                o.push({ value: t, type: i[0].replace(F, " ") }),
                (s = s.slice(t.length))),
              n.filter))
                !(i = V[r].exec(s)) ||
                  (l[r] && !(i = l[r](i))) ||
                  ((t = i.shift()),
                  o.push({ value: t, type: r, matches: i }),
                  (s = s.slice(t.length)));
              if (!t) break;
            }
            return d ? s.length : s ? se.error(e) : x(e, a).slice(0);
          }),
        (s = se.compile =
          function (e, d) {
            var t,
              ...
              s = k[e + " "];
            if (!s) {
              for (d || (d = r(e)), t = d.length; t--; )
                (s = Te(d[t]))[b] ? i.push(s) : o.push(s);
              (s = k(
                e,
                (function (e, d) {
                  var t = d.length > 0,
                    i = e.length > 0,
                    o = function (o, r, s, a, c) {
                      var u,
                        f,
                        g,
                        y = 0,
                      ...
                      for (
                        ...
                        t && ((u = !g && u) && y--, o && m.push(u));
                      }
                      if (((y += v), t && v !== y)) {
                        for (f = 0; (g = d[f++]); ) g(m, b, r, s);
                        if (o) {
                          if (y > 0)
                            for (; v--; ) m[v] || b[v] || (b[v] = O.call(a));
                          b = we(b);
                        }
                        D.apply(a, b),
                          c &&
          ...
          function (e, d, t, i) {
            ...
            if (((t = t || []), 1 === p.length)) {
              if (
                ...
                if (
                  !(d = (n.find.ID(l.matches[0].replace(de, te), d) || [])[0])
                )
                  return t;
                $ && (d = d.parentNode), (e = e.slice(a.shift().value.length));
              }
              for (
                o = V.needsContext.test(e) ? 0 : a.length;
                o-- && ((l = a[o]), !n.relative[(c = l.type)]);

              )
                if (
                  (u = n.find[c]) &&
                  (i = u(
                    l.matches[0].replace(de, te),
                    (ee.test(a[0].type) && ye(d.parentNode)) || d
                  ))
                ) {
                  if ((a.splice(o, 1), !(e = i.length && me(a))))
                    return D.apply(t, i), t;
                  break;
                }
            }
            return (
              ($ || s(e, p))(
                ...
                !h,
                t,
                !d || (ee.test(e) && ye(d.parentNode)) || d
              ),
              t
            );
          }),
        (t.sortStable = b.split("").sort(A).join("") === b),
        (t.detectDuplicates = !!u),
        $(),
        (t.sortDetached = ce(function (e) {
        ...
        ce(function (e) {
          ...
          ue("type|href|height|width", function (e, d, t) {
            if (!t)
        ...
        ce(function (e) {
          ...
          ue(H, function (e, d, t) {
            ...
            if (!t)
              return !0 === e[d]
                ? d.toLowerCase()
                : (n = e.getAttributeNode(d)) && n.specified
                ? n.value
                : null;
          }),
        se
  ...
  var T = function (e, d, t) {
      for (var n = [], i = void 0 !== t; (e = e[d]) && 9 !== e.nodeType; )
        if (1 === e.nodeType) {
          if (i && S(e).is(t)) break;
          n.push(e);
        }
    ...
    x = function (e, d) {
      for (var t = []; e; e = e.nextSibling)
        1 === e.nodeType && e !== d && t.push(e);
      return t;
    },
    k = S.expr.match.needsContext;
  function E(e, d) {
    return e.nodeName && e.nodeName.toLowerCase() === d.toLowerCase();
  }
  var A = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
  function L(e, d, t) {
    return f(d)
      ? S.grep(e, function (e, n) {
          return !!d.call(e, n, e) !== t;
        })
      : d.nodeType
      ? S.grep(e, function (e) {
          return (e === d) !== t;
      ...
      : "string" != typeof d
      ? S.grep(e, function (e) {
          return s.call(d, e) > -1 !== t;
        })
      : S.filter(d, e, t);
  }
  (S.filter = function (e, d, t) {
    var n = d[0];
    return (
      t && (e = ":not(" + e + ")"),
    ...
    S.fn.extend({
      find: function (e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            S(e).filter(function () {
              for (d = 0; d < n; d++) if (S.contains(i[d], this)) return !0;
            })
          );
        for (t = this.pushStack([]), d = 0; d < n; d++) S.find(e, i[d], t);
        return n > 1 ? S.uniqueSort(t) : t;
      },
      filter: function (e) {
      ...
      is: function (e) {
        return !!L(this, "string" == typeof e && k.test(e) ? S(e) : e || [], !1)
          .length;
      },
    });
  var N,
    O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  ((S.fn.init = function (e, d, t) {
    var n, i;
    if (!e) return this;
    if (((t = t || N), "string" == typeof e)) {
      if (
        !(n =
        ...
        return !d || d.jquery ? (d || t).find(e) : this.constructor(d).find(e);
      if (n[1]) {
        if (
          ((d = d instanceof S ? d[0] : d),
          S.merge(
            this,
            S.parseHTML(n[1], d && d.nodeType ? d.ownerDocument || d : g, !0)
          ),
          A.test(n[1]) && S.isPlainObject(d))
        )
          for (n in d) f(this[n]) ? this[n](d[n]) : this.attr(n, d[n]);
        return this;
      }
      return (
  ...
  S.fn.extend({
    has: function (e) {
      ...
      return this.filter(function () {
        for (var e = 0; e < t; e++) if (S.contains(this, d[e])) return !0;
      });
    },
    closest: function (e, d) {
      ...
      if (!k.test(e))
        for (; n < i; n++)
          for (t = this[n]; t && t !== d; t = t.parentNode)
            if (
              t.nodeType < 11 &&
              (r
                ? r.index(t) > -1
                : 1 === t.nodeType && S.find.matchesSelector(t, e))
            ) {
              o.push(t);
              break;
            }
    ...
    add: function (e, d) {
      return this.pushStack(S.uniqueSort(S.merge(this.get(), S(e, d))));
    },
    addBack: function (e) {
    ...
    S.each(
      ...
      function (e, d) {
        S.fn[e] = function (t, n) {
          var i = S.map(this, d, t);
          return (
            "Until" !== e.slice(-5) && (n = t),
            n && "string" == typeof n && (i = S.filter(n, i)),
            this.length > 1 &&
              (D[e] || S.uniqueSort(i), P.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  function _(e, d, t, n) {
    ...
    try {
      e && f((i = e.promise))
        ? i.call(e).done(d).fail(t)
        : e && f((i = e.then))
        ? i.call(e, d, t)
        : d.apply(void 0, [e].slice(n));
    } catch (e) {
      t.apply(void 0, [e]);
    }
  }
  (S.Callbacks = function (e) {
    ...
    var d,
      ...
      s = -1,
      a = function () {
        for (i = i || e.once, n = d = !0; r.length; s = -1)
          for (t = r.shift(); ++s < o.length; )
            !1 === o[s].apply(t[0], t[1]) &&
              e.stopOnFalse &&
              ((s = o.length), (t = !1));
        e.memory || (t = !1), (d = !1), i && (o = t ? [] : "");
      },
      l = {
        add: function () {
          return (
            o &&
              (t && !d && ((s = o.length - 1), r.push(t)),
              (function d(t) {
                S.each(t, function (t, n) {
                  f(n)
                    ? (e.unique && l.has(n)) || o.push(n)
                    : n && n.length && "string" !== m(n) && d(n);
                });
              })(arguments),
              t && !d && a()),
            this
        ...
        remove: function () {
          return (
            S.each(arguments, function (e, d) {
              for (var t; (t = S.inArray(d, o, t)) > -1; )
                o.splice(t, 1), t <= s && s--;
            }),
            this
          );
          ...
          i = {
            ...
            then: function (d, n, i) {
                    ...
                    l = function () {
                      ...
                      if (!(d < o)) {
                        ...
                        (l =
                          ...
                          f(l)
                            ? i
                              ? l.call(e, r(o, t, H, i), r(o, t, j, i))
                              : (o++,
                                l.call(
                                  e,
                                  r(o, t, H, i),
                                  r(o, t, j, i),
                                  r(o, t, H, t.notifyWith)
                                ))
                            : (n !== H && ((s = void 0), (a = [e])),
                              (i || t.resolveWith)(s, a));
                      }
                      ...
                      : function () {
                          try {
                            ...
                            S.Deferred.exceptionHook &&
                              S.Deferred.exceptionHook(e, c.stackTrace),
                              d + 1 >= o &&
                                (n !== j && ((s = void 0), (a = [e])),
                                t.rejectWith(s, a));
                          }
              ...
              return S.Deferred(function (e) {
                t[0][3].add(r(0, e, f(i) ? i : H, e.notifyWith)),
                  t[1][3].add(r(0, e, f(d) ? d : H)),
                  t[2][3].add(r(0, e, f(n) ? n : j));
              }).promise();
            },
            promise: function (e) {
        ...
        return (
          S.each(t, function (e, d) {
            ...
            (i[d[1]] = r.add),
              ...
              (o[d[0]] = function () {
                return (
                  o[d[0] + "With"](this === o ? void 0 : this, arguments), this
                );
              }),
      ...
      when: function (e) {
        var d = arguments.length,
          ...
          s = function (e) {
            return function (t) {
              (n[e] = this),
                (o[e] = arguments.length > 1 ? i.call(arguments) : t),
                --d || r.resolveWith(n, o);
            };
          };
        if (
          d <= 1 &&
          (_(e, r.done(s(t)).resolve, r.reject, !d),
          "pending" === r.state() || f(o[t] && o[t].then))
        )
          return r.then();
        for (; t--; ) _(o[t], s(t), r.reject);
        return r.promise();
      },
    });
  var q = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
  (S.Deferred.exceptionHook = function (d, t) {
    e.console &&
      e.console.warn &&
      d &&
      q.test(d.name) &&
      e.console.warn("jQuery.Deferred exception: " + d.message, d.stack, t);
  }),
    (S.readyException = function (d) {
  ...
  (S.fn.ready = function (e) {
    ...
    S.extend({
      ...
      ready: function (e) {
        (!0 === e ? --S.readyWait : S.isReady) ||
          ((S.isReady = !0),
          (!0 !== e && --S.readyWait > 0) || R.resolveWith(g, [S]));
      },
    }),
    (S.ready.then = R.then),
    ...
    ("loading" !== g.readyState && !g.documentElement.doScroll)
      ...
      : (g.addEventListener("DOMContentLoaded", B),
        e.addEventListener("load", B));
  var F = function (e, d, t, n, i, o, r) {
      var s = 0,
        a = e.length,
        l = null == t;
      if ("object" === m(t))
        for (s in ((i = !0), t)) F(e, d, s, t[s], !0, o, r);
      else if (
        void 0 !== n &&
        ((i = !0),
        f(n) || (r = !0),
        ...
        for (; s < a; s++) d(e[s], t, r ? n : n.call(e[s], s, d(e[s], t)));
      return i ? e : l ? d.call(e) : a ? d(e[0], t) : o;
    },
    W = /^-ms-/,
    U = /-([a-z])/g;
  function z(e, d) {
  ...
  (V.uid = 1),
    (V.prototype = {
      ...
      set: function (e, d, t) {
        var n,
          i = this.cache(e);
        if ("string" == typeof d) i[G(d)] = t;
        else for (n in d) i[G(n)] = d[n];
        return i;
      },
      get: function (e, d) {
        return void 0 === d
          ? this.cache(e)
          : e[this.expando] && e[this.expando][G(d)];
      },
      access: function (e, d, t) {
        return void 0 === d || (d && "string" == typeof d && void 0 === t)
          ? this.get(e, d)
          : (this.set(e, d, t), void 0 !== t ? t : d);
      },
      remove: function (e, d) {
        var t,
          n = e[this.expando];
        if (void 0 !== n) {
          ...
          (void 0 === d || S.isEmptyObject(n)) &&
            (e.nodeType ? (e[this.expando] = void 0) : delete e[this.expando]);
        }
      },
      hasData: function (e) {
        var d = e[this.expando];
        return void 0 !== d && !S.isEmptyObject(d);
      },
    });
  var Y = new V(),
    X = new V(),
  ...
  function Q(e, d, t) {
    ...
    if (void 0 === t && 1 === e.nodeType)
      if (
        ((n = "data-" + d.replace(J, "-$&").toLowerCase()),
        "string" == typeof (t = e.getAttribute(n)))
      ) {
        try {
          t = (function (e) {
            return (
  ...
  S.extend({
    ...
    S.extend({
      ...
      dequeue: function (e, d) {
        ...
        var t = S.queue(e, d),
          ...
          i = t.shift(),
          o = S._queueHooks(e, d);
        "inprogress" === i && ((i = t.shift()), n--),
          i &&
            ("fx" === d && t.unshift("inprogress"),
            delete o.stop,
            i.call(
              e,
              function () {
    ...
    S.fn.extend({
      queue: function (e, d) {
        var t = 2;
        return (
          "string" != typeof e && ((d = e), (e = "fx"), t--),
          arguments.length < t
            ? S.queue(this[0], e)
            : void 0 === d
            ? this
            : this.each(function () {
                var t = S.queue(this, e, d);
      ...
      promise: function (e, d) {
        ...
        for (
          "string" != typeof e && ((d = e), (e = void 0)), e = e || "fx";
          r--;

        )
          (t = Y.get(o[r], e + "queueHooks")) &&
            t.empty &&
            (n++, t.empty.add(s));
        return s(), i.promise(d);
      },
    });
  ...
  function se(e, d, t, n) {
    var i,
      ...
      a = s(),
      l = (t && t[3]) || (S.cssNumber[d] ? "" : "px"),
      c =
        e.nodeType &&
        (S.cssNumber[d] || ("px" !== l && +a)) &&
        de.exec(S.css(e, d));
    if (c && c[3] !== l) {
      for (a /= 2, l = l || c[3], c = +a || 1; r--; )
        S.style(e, d, c + l),
          (1 - o) * (1 - (o = s() / a || 0.5)) <= 0 && (r = 0),
          (c /= o);
      (c *= 2), S.style(e, d, c + l), (t = t || []);
    }
    return (
      t &&
        ((c = +c || +a || 0),
        (i = t[1] ? c + (t[1] + 1) * t[2] : +t[2]),
        n && ((n.unit = l), (n.start = c), (n.end = i))),
      i
    );
  }
  var ae = {};
  function le(e) {
    ...
    return (
      i ||
      ((d = t.body.appendChild(t.createElement(n))),
      (i = S.css(d, "display")),
      ...
      (n = e[o]).style &&
        ...
        d
          ? ("none" === t &&
              ...
              i[o] || (n.style.display = "")),
            "" === n.style.display && re(n) && (i[o] = le(n)))
          : "none" !== t && ((i[o] = "none"), Y.set(n, "display", t)));
    ...
    return (
      (t =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === d || (d && E(e, d)) ? S.merge([e], t) : t
    );
  }
  function ge(e, d) {
    for (var t = 0, n = e.length; t < n; t++)
      Y.set(e[t], "globalEval", !d || Y.get(d[t], "globalEval"));
  }
  ...
  function ve(e, d, t, n, i) {
    for (
      ...
      if ((o = e[p]) || 0 === o)
        if ("object" === m(o)) S.merge($, o.nodeType ? [o] : o);
        else if (ye.test(o)) {
          for (
            r = r || u.appendChild(d.createElement("div")),
              s = ($e.exec(o) || ["", ""])[1].toLowerCase(),
              a = fe[s] || fe._default,
              r.innerHTML = a[1] + S.htmlPrefilter(o) + a[2],
              c = a[0];
            c--;

          )
            r = r.lastChild;
          S.merge($, r.childNodes), ((r = u.firstChild).textContent = "");
        } else $.push(d.createTextNode(o));
    for (u.textContent = "", p = 0; (o = $[p++]); )
      if (n && S.inArray(o, n) > -1) i && i.push(o);
      else if (
        ((l = ie(o)), (r = he(u.appendChild(o), "script")), l && ge(r), t)
      )
        for (c = 0; (o = r[c++]); ) pe.test(o.type || "") && t.push(o);
    return u;
  }
  var me = /^([^.]*)(?:\.(.+)|)/;
  function be() {
  ...
  function Ce(e, d, t, n, i, o) {
    var r, s;
    if ("object" == typeof d) {
      for (s in ("string" != typeof t && ((n = n || t), (t = void 0)), d))
        Ce(e, s, t, n, d[s], o);
      return e;
    }
    if (
    ...
    return (
      1 === o &&
        ...
        (i.guid = r.guid || (r.guid = S.guid++))),
      e.each(function () {
        S.event.add(this, d, i, n, t);
      })
    );
  }
  function Te(e, d, t) {
    t
        ...
        S.event.add(e, d, {
          ...
          handler: function (e) {
            var n,
              o,
              r = Y.get(this, d);
            if (1 & e.isTrigger && this[d]) {
              if (r.length)
                (S.event.special[d] || {}).delegateType && e.stopPropagation();
              else if (
                ((r = i.call(arguments)),
                Y.set(this, d, r),
                (n = t(this, d)),
                this[d](),
                r !== (o = Y.get(this, d)) || n ? Y.set(this, d, !1) : (o = {}),
                r !== o)
              )
                return (
      ...
      : void 0 === Y.get(e, d) && S.event.add(e, d, be);
  }
  (S.event = {
    global: {},
    add: function (e, d, t, n, i) {
      var o,
        r,
        s,
        a,
      ...
      if (K(e))
        for (
          t.handler && ((t = (o = t).handler), (i = o.selector)),
            i && S.find.matchesSelector(ne, i),
            t.guid || (t.guid = S.guid++),
            (a = g.events) || (a = g.events = Object.create(null)),
            (r = g.handle) ||
              (r = g.handle =
                function (d) {
                  return void 0 !== S && S.event.triggered !== d.type
                    ? S.event.dispatch.apply(e, arguments)
                    : void 0;
                }),
            l = (d = (d || "").match(I) || [""]).length;
          l--;
          ...
          (p = h = (s = me.exec(d[l]) || [])[1]),
            ...
            p &&
              ...
              u.add &&
                (u.add.call(e, c), c.handler.guid || (c.handler.guid = t.guid)),
              i ? $.splice($.delegateCount++, 0, c) : $.push(c),
              (S.event.global[p] = !0));
    },
    remove: function (e, d, t, n, i) {
      var o,
        r,
        s,
        a,
      ...
      if (g && (a = g.events)) {
        for (l = (d = (d || "").match(I) || [""]).length; l--; )
          if (
            ...
            for (
              u = S.event.special[p] || {},
                $ = a[(p = (n ? u.delegateType : u.bindType) || p)] || [],
                s =
                  s[2] &&
                  new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                r = o = $.length;
            ...
            r &&
              ...
              delete a[p]);
          } else for (p in a) S.event.remove(e, p + d[l], t, n, !0);
        S.isEmptyObject(a) && Y.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var d,
      ...
      for (s[0] = a, d = 1; d < arguments.length; d++) s[d] = arguments[d];
      if (
        ((a.delegateTarget = this),
        !c.preDispatch || !1 !== c.preDispatch.call(this, a))
      ) {
        for (
          r = S.event.handlers.call(this, a, l), d = 0;
          (i = r[d++]) && !a.isPropagationStopped();

        )
          for (
            a.currentTarget = i.elem, t = 0;
            (o = i.handlers[t++]) && !a.isImmediatePropagationStopped();
    ...
    handlers: function (e, d) {
      var t,
        ...
        a = d.delegateCount,
        l = e.target;
      if (a && l.nodeType && !("click" === e.type && e.button >= 1))
        for (; l !== this; l = l.parentNode || this)
          if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
            for (o = [], r = {}, t = 0; t < a; t++)
              void 0 === r[(i = (n = d[t]).selector + " ")] &&
                (r[i] = n.needsContext
                  ? S(i, this).index(l) > -1
      ...
      return (
        (l = this), a < d.length && s.push({ elem: l, handlers: d.slice(a) }), s
      );
    },
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var d = this || e;
          return (
            ue.test(d.type) && d.click && E(d, "input") && Te(d, "click", be),
            !1
          );
        },
        trigger: function (e) {
          var d = this || e;
          return (
            ue.test(d.type) && d.click && E(d, "input") && Te(d, "click"), !0
          );
        },
        _default: function (e) {
          var d = e.target;
    ...
    (S.removeEvent = function (e, d, t) {
      e.removeEventListener && e.removeEventListener(d, t);
    }),
    (S.Event = function (e, d) {
      if (!(this instanceof S.Event)) return new S.Event(e, d);
      e && e.type
    ...
    S.each({ focus: "focusin", blur: "focusout" }, function (e, d) {
      S.event.special[e] = {
        setup: function () {
    ...
    S.fn.extend({
      on: function (e, d, t, n) {
        return Ce(this, e, d, t, n);
      },
      one: function (e, d, t, n) {
        return Ce(this, e, d, t, n, 1);
      },
      off: function (e, d, t) {
        var n, i;
        ...
        if ("object" == typeof e) {
          for (i in e) this.off(i, d, e[i]);
          return this;
        }
        return (
          (!1 !== d && "function" != typeof d) || ((t = d), (d = void 0)),
          !1 === t && (t = Se),
          this.each(function () {
            S.event.remove(this, e, t, d);
          })
        );
      },
    });
  ...
  function Ae(e, d) {
    return (
      (E(e, "table") &&
        E(11 !== d.nodeType ? d : d.firstChild, "tr") &&
  ...
  function Oe(e, d) {
    ...
    if (1 === d.nodeType) {
      if (Y.hasData(e) && (s = Y.get(e).events))
        for (i in (Y.remove(d, "handle events"), s))
          for (t = 0, n = s[i].length; t < n; t++) S.event.add(d, i, s[i][t]);
      X.hasData(e) && ((o = X.access(e)), (r = S.extend({}, o)), X.set(d, r));
    }
  }
  function Pe(e, d) {
    var t = d.nodeName.toLowerCase();
    "input" === t && ue.test(e.type)
      ? (d.checked = e.checked)
      : ("input" !== t && "textarea" !== t) ||
  ...
  function De(e, d, t, n) {
    ...
    var i,
      ...
      g = d[0],
      y = f(g);
    if (y || ($ > 1 && "string" == typeof g && !p.checkClone && ke.test(g)))
      return e.each(function (i) {
        var o = e.eq(i);
        y && (d[0] = g.call(this, i, o.html())), De(o, d, t, n);
      });
    if (
      $ &&
      ((r = (i = ve(d, e[0].ownerDocument, !1, e, n)).firstChild),
      1 === i.childNodes.length && (i = r),
      r || n)
    ) {
      for (a = (s = S.map(he(i, "script"), Le)).length; u < $; u++)
        (l = i),
          u !== h &&
          ...
          (l = s[u]),
            pe.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : v(l.textContent.replace(Ee, ""), l, c));
    }
    return e;
  }
  function Me(e, d, t) {
    for (var n, i = d ? S.filter(d, e) : e, o = 0; null != (n = i[o]); o++)
      t || 1 !== n.nodeType || S.cleanData(he(n)),
        n.parentNode &&
          (t && ie(n) && ge(he(n, "script")), n.parentNode.removeChild(n));
    return e;
  }
  S.extend({
    ...
    clone: function (e, d, t) {
      ...
      if (
        ...
        for (r = he(s), n = 0, i = (o = he(e)).length; n < i; n++)
          Pe(o[n], r[n]);
      if (d)
        if (t)
          for (o = o || he(e), r = r || he(s), n = 0, i = o.length; n < i; n++)
            Oe(o[n], r[n]);
        else Oe(e, s);
      return (
        (r = he(s, "script")).length > 0 && ge(r, !a && he(e, "script")), s
      );
    },
    cleanData: function (e) {
      for (var d, t, n, i = S.event.special, o = 0; void 0 !== (t = e[o]); o++)
        if (K(t)) {
          if ((d = t[Y.expando])) {
            if (d.events)
              for (n in d.events)
                i[n] ? S.event.remove(t, n) : S.removeEvent(t, n, d.handle);
            t[Y.expando] = void 0;
          }
          t[X.expando] && (t[X.expando] = void 0);
        }
    },
  }),
    S.fn.extend({
        ...
        return F(
          ...
          function (e) {
            var d = this[0] || {},
              t = 0,
              n = this.length;
            if (void 0 === e && 1 === d.nodeType) return d.innerHTML;
            if (
              "string" == typeof e &&
              !xe.test(e) &&
              !fe[($e.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = S.htmlPrefilter(e);
              try {
                for (; t < n; t++)
                  1 === (d = this[t] || {}).nodeType &&
                    (S.cleanData(he(d, !1)), (d.innerHTML = e));
                d = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return De(
          ...
          function (d) {
            ...
            S.inArray(this, e) < 0 &&
              (S.cleanData(he(this)), t && t.replaceChild(d, this));
          },
          e
        );
      },
    ...
    S.each(
      ...
      function (e, d) {
        S.fn[e] = function (e) {
          for (var t, n = [], i = S(e), o = i.length - 1, s = 0; s <= o; s++)
  ...
  var Ie = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"),
    He = /^--/,
    je = function (d) {
      var t = d.ownerDocument.defaultView;
      return (t && t.opener) || (t = e), t.getComputedStyle(d);
    },
    _e = function (e, d, t) {
      var n,
        i,
        o = {};
      for (i in d) (o[i] = e.style[i]), (e.style[i] = d[i]);
      for (i in ((n = t.call(e)), d)) e.style[i] = o[i];
      return n;
    },
    qe = new RegExp(te.join("|"), "i"),
    Re = "[\\x20\\t\\r\\n\\f]",
    Be = new RegExp("^" + Re + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Re + "+$", "g");
  function Fe(e, d, t) {
    var n,
      i,
      o,
    ...
    return (
      (t = t || je(e)) &&
        ((r = t.getPropertyValue(d) || t[d]),
        s && r && (r = r.replace(Be, "$1") || void 0),
        "" !== r || ie(e) || (r = S.style(e, d)),
        !p.pixelBoxStyles() &&
          Ie.test(r) &&
          qe.test(d) &&
          ((n = a.width),
  ...
  function We(e, d) {
    return {
      get: function () {
        if (!e()) return (this.get = d).apply(this, arguments);
        delete this.get;
      },
    };
  }
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == s &&
              ...
              ne.appendChild(d).appendChild(t).appendChild(n),
    ...
    return (
      ...
      (e in ze
        ...
        : (Ge[e] =
            (function (e) {
              for (
                var d = e[0].toUpperCase() + e.slice(1), t = Ue.length;
                t--;

              )
                if ((e = Ue[t] + d) in ze) return e;
            })(e) || e))
    );
  }
  ...
  function Ze(e, d, t) {
    var n = de.exec(d);
    return n ? Math.max(0, n[2] - (t || 0)) + (n[3] || "px") : d;
  }
  function Je(e, d, t, n, i, o) {
    var r = "width" === d ? 1 : 0,
      s = 0,
      a = 0;
    if (t === (n ? "border" : "content")) return 0;
    for (; r < 4; r += 2)
      "margin" === t && (a += S.css(e, t + te[r], !0, i)),
        n
          ? ("content" === t && (a -= S.css(e, "padding" + te[r], !0, i)),
            "margin" !== t &&
              (a -= S.css(e, "border" + te[r] + "Width", !0, i)))
          : ((a += S.css(e, "padding" + te[r], !0, i)),
            "padding" !== t
              ? (a += S.css(e, "border" + te[r] + "Width", !0, i))
              : (s += S.css(e, "border" + te[r] + "Width", !0, i)));
    return (
      !n &&
        o >= 0 &&
        (a +=
          Math.max(
            0,
            Math.ceil(
              e["offset" + d[0].toUpperCase() + d.slice(1)] - o - a - s - 0.5
            )
          ) || 0),
      a
    );
  ...
  function Qe(e, d, t) {
    ...
    return (
      ((!p.boxSizingReliable() && i) ||
        ...
        ((i = "border-box" === S.css(e, "boxSizing", !1, n)),
        (o = s in e) && (r = e[s])),
      (r = parseFloat(r) || 0) +
        Je(e, d, t || (i ? "border" : "content"), o, n, r) +
        "px"
    );
  }
  function ed(e, d, t, n, i) {
    return new ed.prototype.init(e, d, t, n, i);
  }
  S.extend({
    cssHooks: {
      opacity: {
    ...
    style: function (e, d, t, n) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (a || (d = Ke(s)), (r = S.cssHooks[d] || S.cssHooks[s]), void 0 === t)
        )
          return r && "get" in r && void 0 !== (i = r.get(e, !1, n)) ? i : l[d];
        "string" === (o = typeof t) &&
          (i = de.exec(t)) &&
          i[1] &&
          ((t = se(e, d, i)), (o = "number")),
          null != t &&
            ...
            ("number" !== o ||
              a ||
              (t += (i && i[3]) || (S.cssNumber[s] ? "" : "px")),
            p.clearCloneStyle ||
              "" !== t ||
              0 !== d.indexOf("background") ||
              (l[d] = "inherit"),
            (r && "set" in r && void 0 === (t = r.set(e, t, n))) ||
              (a ? l.setProperty(d, t) : (l[d] = t)));
      }
    },
    css: function (e, d, t, n) {
      ...
      return (
        He.test(d) || (d = Ke(s)),
        (r = S.cssHooks[d] || S.cssHooks[s]) &&
          "get" in r &&
          (i = r.get(e, !0, t)),
        void 0 === i && (i = Fe(e, d, n)),
        "normal" === i && d in Xe && (i = Xe[d]),
        "" === t || t
          ? ((o = parseFloat(i)), !0 === t || isFinite(o) ? o || 0 : i)
          : i
      );
    },
  }),
    S.each(["height", "width"], function (e, d) {
      S.cssHooks[d] = {
        get: function (e, t, n) {
          if (t)
        ...
        set: function (e, t, n) {
          ...
          return (
            s &&
              r &&
              (a -= Math.ceil(
                e["offset" + d[0].toUpperCase() + d.slice(1)] -
                  parseFloat(o[d]) -
                  Je(e, d, "border", !1, o) -
                  0.5
              )),
            a &&
              (i = de.exec(t)) &&
              "px" !== (i[3] || "px") &&
              ((e.style[d] = t), (t = S.css(e, d))),
            Ze(0, t, a)
          );
        },
      };
    }),
    (S.cssHooks.marginLeft = We(p.reliableMarginLeft, function (e, d) {
      if (d)
        return (
    ...
    S.each({ margin: "", padding: "", border: "Width" }, function (e, d) {
      (S.cssHooks[e + d] = {
        expand: function (t) {
          for (
            var n = 0, i = {}, o = "string" == typeof t ? t.split(" ") : [t];
            n < 4;
            n++
          )
            i[e + te[n] + d] = o[n] || o[n - 2] || o[0];
          return i;
        },
      }),
        "margin" !== e && (S.cssHooks[e + d].set = Ze);
    }),
    S.fn.extend({
      css: function (e, d) {
        return F(
          ...
          function (e, d, t) {
            var n,
              ...
              r = 0;
            if (Array.isArray(d)) {
              for (n = je(e), i = d.length; r < i; r++)
                o[d[r]] = S.css(e, d[r], !1, n);
              return o;
            }
            return void 0 !== t ? S.style(e, d, t) : S.css(e, d);
          },
          e,
          d,
          arguments.length > 1
    ...
    (ed.prototype = {
      ...
      init: function (e, d, t, n, i, o) {
        (this.elem = e),
          ...
          (this.end = n),
          (this.unit = o || (S.cssNumber[t] ? "" : "px"));
      },
      cur: function () {
        var e = ed.propHooks[this.prop];
        return e && e.get ? e.get(this) : ed.propHooks._default.get(this);
      },
      run: function (e) {
        var d,
          t = ed.propHooks[this.prop];
        return (
          ...
          t && t.set ? t.set(this) : ed.propHooks._default.set(this),
          this
        );
      },
    }),
    (ed.prototype.init.prototype = ed.prototype),
    (ed.propHooks = {
      _default: {
        get: function (e) {
          var d;
    ...
    (ed.propHooks.scrollTop = ed.propHooks.scrollLeft =
      {
        set: function (e) {
  ...
  function od() {
    td &&
      (!1 === g.hidden && e.requestAnimationFrame
        ? e.requestAnimationFrame(od)
        : e.setTimeout(od, S.fx.interval),
      S.fx.tick());
  }
  function rd() {
    return (
  ...
  function sd(e, d) {
    var t,
      n = 0,
      i = { height: e };
    for (d = d ? 1 : 0; n < 4; n += 2 - d)
      i["margin" + (t = te[n])] = i["padding" + t] = e;
    return d && (i.opacity = i.width = e), i;
  }
  function ad(e, d, t) {
    for (
      var n,
        i = (ld.tweeners[d] || []).concat(ld.tweeners["*"]),
        o = 0,
        r = i.length;
      o < r;
      o++
    )
      if ((n = i[o].call(t, d, e))) return n;
  }
  function ld(e, d, t) {
    var n,
      i,
      o = 0,
      r = ld.prefilters.length,
      ...
      a = function () {
        ...
        for (
          var d = dd || rd(),
            t = Math.max(0, l.startTime + l.duration - d),
            n = 1 - (t / l.duration || 0),
            o = 0,
            r = l.tweens.length;
          o < r;
        ...
        return (
          ...
          n < 1 && r
            ? t
            : (r || s.notifyWith(e, [l, 1, 0]), s.resolveWith(e, [l]), !1)
        );
      },
      l = s.promise({
        elem: e,
        ...
        createTween: function (d, t) {
          var n = S.Tween(
            ...
            d,
            t,
            l.opts.specialEasing[d] || l.opts.easing
          );
          return l.tweens.push(n), n;
        },
        stop: function (d) {
          var t = 0,
            n = d ? l.tweens.length : 0;
          if (i) return this;
          for (i = !0; t < n; t++) l.tweens[t].run(1);
          return (
            d
              ? (s.notifyWith(e, [l, 1, 0]), s.resolveWith(e, [l, d]))
              : s.rejectWith(e, [l, d]),
            this
          );
        },
      ...
      !(function (e, d) {
        ...
        for (t in e)
          if (
            ((i = d[(n = G(t))]),
            (o = e[t]),
            Array.isArray(o) && ((i = o[1]), (o = e[t] = o[0])),
            t !== n && ((e[n] = o), delete e[t]),
            (r = S.cssHooks[n]) && ("expand" in r))
          )
            for (t in ((o = r.expand(o)), delete e[n], o))
              (t in e) || ((e[t] = o[t]), (d[t] = i));
          else d[n] = i;
      })(c, l.opts.specialEasing);
      o < r;
      o++
    )
      if ((n = ld.prefilters[o].call(l, e, c, l.opts)))
        return (
          f(n.stop) &&
    ...
    return (
      ...
      S.fx.timer(S.extend(a, { elem: e, anim: l, queue: l.opts.queue })),
      l
    );
  }
  (S.Animation = S.extend(ld, {
    tweeners: {
      "*": [
        function (e, d) {
          var t = this.createTween(e, d);
          return se(t.elem, e, de.exec(d), t), t;
        },
      ],
    },
    tweener: function (e, d) {
      f(e) ? ((d = e), (e = ["*"])) : (e = e.match(I));
      for (var t, n = 0, i = e.length; n < i; n++)
        (t = e[n]),
          (ld.tweeners[t] = ld.tweeners[t] || []),
          ld.tweeners[t].unshift(d);
    },
    prefilters: [
      function (e, d, t) {
        var n,
        ...
        if ((a = !S.isEmptyObject(d)) || !S.isEmptyObject(p))
          for (n in (u &&
            1 === e.nodeType &&
            ((t.overflow = [f.overflow, f.overflowX, f.overflowY]),
          ...
          t.overflow &&
            ((f.overflow = "hidden"),
            $.always(function () {
              (f.overflow = t.overflow[0]),
                (f.overflowX = t.overflow[1]),
                (f.overflowY = t.overflow[2]);
            })),
          (a = !1),
          p))
            a ||
              ...
              h && ce([e], !0),
              $.done(function () {
                for (n in (h || ce([e]), Y.remove(e, "fxshow"), p))
                  S.style(e, n, p[n]);
              })),
              (a = ad(h ? g[n] : 0, n, $)),
              n in g ||
                ((g[n] = a.start), h && ((a.end = a.start), (a.start = 0)));
      },
    ],
    prefilter: function (e, d) {
      d ? ld.prefilters.unshift(e) : ld.prefilters.push(e);
    },
  })),
    (S.speed = function (e, d, t) {
      var n =
        e && "object" == typeof e
          ? S.extend({}, e)
          : {
              complete: t || (!t && d) || (f(e) && e),
              duration: e,
              easing: (t && d) || (d && !f(d) && d),
            };
      return (
    ...
    S.fn.extend({
      fadeTo: function (e, d, t, n) {
        return this.filter(re)
          .css("opacity", 0)
          .show()
          .end()
          .animate({ opacity: d }, e, t, n);
      },
      animate: function (e, d, t, n) {
        var i = S.isEmptyObject(e),
          o = S.speed(d, t, n),
          r = function () {
            var d = ld(this, S.extend({}, e), o);
            (i || Y.get(this, "finish")) && d.stop(!0);
          };
        return (
          (r.finish = r),
      ...
      stop: function (e, d, t) {
        ...
        return (
          "string" != typeof e && ((t = d), (d = e), (e = void 0)),
          d && this.queue(e || "fx", []),
          this.each(function () {
            var d = !0,
            ...
            else for (i in r) r[i] && r[i].stop && id.test(i) && n(r[i]);
            for (i = o.length; i--; )
              o[i].elem !== this ||
                (null != e && o[i].queue !== e) ||
                (o[i].anim.stop(t), (d = !1), o.splice(i, 1));
            (!d && t) || S.dequeue(this, e);
          })
        );
      },
      finish: function (e) {
        return (
          ...
          this.each(function () {
            ...
            for (
              ...
              o[d].elem === this &&
                o[d].queue === e &&
                (o[d].anim.stop(!0), o.splice(d, 1));
            for (d = 0; d < r; d++)
              n[d] && n[d].finish && n[d].finish.call(this);
            delete t.finish;
          })
        );
      },
    }),
    S.each(["toggle", "show", "hide"], function (e, d) {
      var t = S.fn[d];
      S.fn[d] = function (e, n, i) {
        return null == e || "boolean" == typeof e
          ? t.apply(this, arguments)
          : this.animate(sd(d, !0), e, n, i);
      };
    }),
    S.each(
      {
    ...
    (S.fx.tick = function () {
      var e,
        d = 0,
        t = S.timers;
      for (dd = Date.now(); d < t.length; d++)
        (e = t[d])() || t[d] !== e || t.splice(d--, 1);
      t.length || S.fx.stop(), (dd = void 0);
    }),
    ...
    (S.fn.delay = function (d, t) {
      return (
        (d = (S.fx && S.fx.speeds[d]) || d),
        (t = t || "fx"),
        this.queue(t, function (t, n) {
          var i = e.setTimeout(t, d);
          n.stop = function () {
            e.clearTimeout(i);
          };
        })
    ...
    (function () {
      ...
      (e.type = "checkbox"),
        (p.checkOn = "" !== e.value),
        (p.optSelected = d.selected),
        ((e = g.createElement("input")).value = "t"),
        (e.type = "radio"),
        (p.radioValue = "t" === e.value);
    })();
  var cd,
    ud = S.expr.attrHandle;
  S.fn.extend({
    attr: function (e, d) {
      return F(this, S.attr, e, d, arguments.length > 1);
    },
    ...
    S.extend({
      attr: function (e, d, t) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ...
            : ((1 === o && S.isXMLDoc(e)) ||
                (i =
                  S.attrHooks[d.toLowerCase()] ||
                  (S.expr.match.bool.test(d) ? cd : void 0)),
              void 0 !== t
                ? null === t
                  ? void S.removeAttr(e, d)
                  : i && "set" in i && void 0 !== (n = i.set(e, t, d))
                  ? n
                  : (e.setAttribute(d, t + ""), t)
                : i && "get" in i && null !== (n = i.get(e, d))
                ? n
                : null == (n = S.find.attr(e, d))
                ? void 0
                : n);
      },
      attrHooks: {
        type: {
          set: function (e, d) {
            if (!p.radioValue && "radio" === d && E(e, "input")) {
              var t = e.value;
              return e.setAttribute("type", d), t && (e.value = t), d;
            }
          },
        },
      },
      removeAttr: function (e, d) {
        var t,
          n = 0,
          i = d && d.match(I);
        if (i && 1 === e.nodeType) for (; (t = i[n++]); ) e.removeAttribute(t);
      },
    }),
    (cd = {
      set: function (e, d, t) {
        return !1 === d ? S.removeAttr(e, t) : e.setAttribute(t, t), t;
      },
    }),
    S.each(S.expr.match.bool.source.match(/\w+/g), function (e, d) {
      var t = ud[d] || S.find.attr;
      ud[d] = function (e, d, n) {
        var i,
          o,
          r = d.toLowerCase();
  ...
  S.fn.extend({
    prop: function (e, d) {
      return F(this, S.prop, e, d, arguments.length > 1);
    },
    ...
    S.extend({
      prop: function (e, d, t) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && S.isXMLDoc(e)) ||
              ((d = S.propFix[d] || d), (i = S.propHooks[d])),
            void 0 !== t
              ? i && "set" in i && void 0 !== (n = i.set(e, t, d))
                ? n
                : (e[d] = t)
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            var d = S.find.attr(e, "tabindex");
            return d
              ? parseInt(d, 10)
              : $d.test(e.nodeName) || (pd.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
    ...
    S.fn.extend({
      addClass: function (e) {
        ...
        return f(e)
          ? this.each(function (d) {
              S(this).addClass(e.call(this, d, hd(this)));
            })
          : (d = gd(e)).length
          ? this.each(function () {
              if (
                ((n = hd(this)), (t = 1 === this.nodeType && " " + fd(n) + " "))
              ) {
                for (o = 0; o < d.length; o++)
                  (i = d[o]), t.indexOf(" " + i + " ") < 0 && (t += i + " ");
                (r = fd(t)), n !== r && this.setAttribute("class", r);
              }
            })
          : this;
      },
      removeClass: function (e) {
        ...
        return f(e)
          ? this.each(function (d) {
              S(this).removeClass(e.call(this, d, hd(this)));
            })
          : arguments.length
          ? (d = gd(e)).length
            ? this.each(function () {
                if (
                  ((n = hd(this)),
                  (t = 1 === this.nodeType && " " + fd(n) + " "))
                ) {
                  for (o = 0; o < d.length; o++)
                    for (i = d[o]; t.indexOf(" " + i + " ") > -1; )
                      t = t.replace(" " + i + " ", " ");
                  (r = fd(t)), n !== r && this.setAttribute("class", r);
                }
              })
      ...
      toggleClass: function (e, d) {
        ...
        return f(e)
          ? this.each(function (t) {
              S(this).toggleClass(e.call(this, t, hd(this), d), d);
            })
          : "boolean" == typeof d && s
          ? d
            ? this.addClass(e)
          ...
          : ((t = gd(e)),
            this.each(function () {
              if (s)
                for (o = S(this), i = 0; i < t.length; i++)
                  (n = t[i]), o.hasClass(n) ? o.removeClass(n) : o.addClass(n);
              else
                (void 0 !== e && "boolean" !== r) ||
                  ((n = hd(this)) && Y.set(this, "__className__", n),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      n || !1 === e ? "" : Y.get(this, "__className__") || ""
                    ));
            }));
      },
      hasClass: function (e) {
        var d,
          ...
          n = 0;
        for (d = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && (" " + fd(hd(t)) + " ").indexOf(d) > -1)
            return !0;
        return !1;
      },
    });
  ...
  S.fn.extend({
      ...
      return arguments.length
        ? ((n = f(e)),
          this.each(function (t) {
            var i;
            1 === this.nodeType &&
              (null == (i = n ? e.call(this, t, S(this).val()) : e)
                ? (i = "")
                : "number" == typeof i
                ? (i += "")
                : Array.isArray(i) &&
              ...
              ((d =
                ...
                "set" in d &&
                void 0 !== d.set(this, i, "value")) ||
                (this.value = i));
          }))
        : i
        ? (d = S.valHooks[i.type] || S.valHooks[i.nodeName.toLowerCase()]) &&
          "get" in d &&
          void 0 !== (t = d.get(i, "value"))
          ? t
    ...
    S.extend({
      valHooks: {
        option: {
          get: function (e) {
            var d = S.find.attr(e, "value");
            return null != d ? d : fd(S.text(e));
          },
        },
        select: {
          get: function (e) {
            var d,
              ...
              s = r ? null : [],
              a = r ? o + 1 : i.length;
            for (n = o < 0 ? a : r ? o : 0; n < a; n++)
              if (
                ((t = i[n]).selected || n === o) &&
                !t.disabled &&
                (!t.parentNode.disabled || !E(t.parentNode, "optgroup"))
              ) {
                if (((d = S(t).val()), r)) return d;
                s.push(d);
              }
            return s;
          },
          set: function (e, d) {
            for (
              var t, n, i = e.options, o = S.makeArray(d), r = i.length;
              r--;

            )
              ((n = i[r]).selected =
                S.inArray(S.valHooks.option.get(n), o) > -1) && (t = !0);
    ...
    S.each(["radio", "checkbox"], function () {
      (S.valHooks[this] = {
        set: function (e, d) {
          if (Array.isArray(d))
            return (e.checked = S.inArray(S(e).val(), d) > -1);
        },
      }),
        p.checkOn ||
  ...
  var vd = /^(?:focusinfocus|focusoutblur)$/,
    md = function (e) {
      e.stopPropagation();
    };
  S.extend(S.event, {
    trigger: function (d, t, n, i) {
      var o,
        r,
        s,
        a,
        ...
        p,
        y = [n || g],
        v = c.call(d, "type") ? d.type : d,
        m = c.call(d, "namespace") ? d.namespace.split(".") : [];
      if (
        ((r = p = s = n = n || g),
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !vd.test(v + S.event.triggered) &&
          (v.indexOf(".") > -1 &&
            ((m = v.split(".")), (v = m.shift()), m.sort()),
          (l = v.indexOf(":") < 0 && "on" + v),
          ((d = d[S.expando]
            ? d
            : new S.Event(v, "object" == typeof d && d)).isTrigger = i ? 2 : 3),
          (d.namespace = m.join(".")),
          ...
          (d.result = void 0),
          d.target || (d.target = n),
          (t = null == t ? [d] : S.makeArray(t, [d])),
          ($ = S.event.special[v] || {}),
          i || !$.trigger || !1 !== $.trigger.apply(n, t)))
      ) {
        if (!i && !$.noBubble && !h(n)) {
          for (
            a = $.delegateType || v, vd.test(a + v) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            y.push(r), (s = r);
        ...
        for (o = 0; (r = y[o++]) && !d.isPropagationStopped(); )
          (p = r),
            (d.type = o > 1 ? a : $.bindType || v),
            (u =
              (Y.get(r, "events") || Object.create(null))[d.type] &&
              Y.get(r, "handle")) && u.apply(r, t),
            (u = l && r[l]) &&
              u.apply &&
              K(r) &&
              ((d.result = u.apply(r, t)),
              !1 === d.result && d.preventDefault());
        return (
          (d.type = v),
          i ||
            d.isDefaultPrevented() ||
            ($._default && !1 !== $._default.apply(y.pop(), t)) ||
            !K(n) ||
            (l &&
              f(n[v]) &&
              !h(n) &&
              ((s = n[l]) && (n[l] = null),
              (S.event.triggered = v),
              d.isPropagationStopped() && p.addEventListener(v, md),
              n[v](),
              d.isPropagationStopped() && p.removeEventListener(v, md),
    ...
    simulate: function (e, d, t) {
      var n = S.extend(new S.Event(), t, { type: e, isSimulated: !0 });
      S.event.trigger(n, null, d);
    },
  }),
    S.fn.extend({
      trigger: function (e, d) {
        return this.each(function () {
          S.event.trigger(e, d, this);
        });
      },
      triggerHandler: function (e, d) {
        var t = this[0];
        if (t) return S.event.trigger(e, d, t, !0);
      },
    }),
    p.focusin ||
      S.each({ focus: "focusin", blur: "focusout" }, function (e, d) {
        var t = function (e) {
          S.event.simulate(d, e.target, S.event.fix(e));
        };
        S.event.special[d] = {
          setup: function () {
            var n = this.ownerDocument || this.document || this,
              i = Y.access(n, d);
            i || n.addEventListener(e, t, !0), Y.access(n, d, (i || 0) + 1);
          },
          teardown: function () {
            var n = this.ownerDocument || this.document || this,
              i = Y.access(n, d) - 1;
            i
              ? Y.access(n, d, i)
              : (n.removeEventListener(e, t, !0), Y.remove(n, d));
          },
        };
      });
  var bd = e.location,
    Sd = { guid: Date.now() },
    wd = /\?/;
  S.parseXML = function (d) {
    var t, n;
    if (!d || "string" != typeof d) return null;
    try {
      t = new e.DOMParser().parseFromString(d, "text/xml");
    } catch (e) {}
    return (
  ...
  function Ed(e, d, t, n) {
    var i;
    if (Array.isArray(d))
      S.each(d, function (d, i) {
        t || Cd.test(e)
          ? n(e, i)
          : Ed(
              e + "[" + ("object" == typeof i && null != i ? d : "") + "]",
              i,
              t,
              n
            );
      });
    else if (t || "object" !== m(d)) n(e, d);
    else for (i in d) Ed(e + "[" + i + "]", d[i], t, n);
  }
  (S.param = function (e, d) {
    var t,
      n = [],
      i = function (e, d) {
        var t = f(d) ? d() : d;
        ...
        return this.map(function () {
          ...
          .map(function (e, d) {
            ...
            return null == t
              ...
              : Array.isArray(t)
              ? S.map(t, function (e) {
                  return { name: d.name, value: e.replace(Td, "\r\n") };
                })
  ...
  var Ad = /%20/g,
    ...
    Id = {},
    Hd = "*/".concat("*"),
    jd = g.createElement("a");
  function _d(e) {
    return function (d, t) {
      "string" != typeof d && ((t = d), (d = "*"));
      var n,
        i = 0,
        o = d.toLowerCase().match(I) || [];
      if (f(t))
        for (; (n = o[i++]); )
          "+" === n[0]
            ? ((n = n.slice(1) || "*"), (e[n] = e[n] || []).unshift(t))
            : (e[n] = e[n] || []).push(t);
    };
  }
  function qd(e, d, t, n) {
        ...
        S.each(e[s] || [], function (e, s) {
          ...
          return "string" != typeof l || o || i[l]
            ? o
              ? !(a = l)
              : void 0
            : (d.dataTypes.unshift(l), r(l), !1);
        }),
        a
      );
    }
    return r(d.dataTypes[0]) || (!i["*"] && r("*"));
  }
  function Rd(e, d) {
    var t,
      n,
      i = S.ajaxSettings.flatOptions || {};
    for (t in d) void 0 !== d[t] && ((i[t] ? e : n || (n = {}))[t] = d[t]);
  ...
  (jd.href = bd.href),
    S.extend({
      ...
      ajaxSetup: function (e, d) {
        return d ? Rd(Rd(e, S.ajaxSettings), d) : Rd(S.ajaxSettings, e);
      },
      ajaxPrefilter: _d(Md),
      ajaxTransport: _d(Id),
      ajax: function (d, t) {
        "object" == typeof d && ((t = d), (d = void 0)), (t = t || {});
        var n,
          i,
          o,
          r,
          ...
          p = S.ajaxSetup({}, t),
          f = p.context || p,
          h = p.context && (f.nodeType || f.jquery) ? S(f) : S.event,
          y = S.Deferred(),
          ...
          T = {
            ...
            statusCode: function (e) {
              ...
              if (e)
                ...
                else for (d in e) m[d] = [m[d], e[d]];
              return this;
            },
            abort: function (e) {
              var d = e || C;
              return n && n.abort(d), x(0, d), this;
            },
          };
        if (
          (y.promise(T),
          (p.url = ((d || p.url || bd.href) + "").replace(
            Dd,
            bd.protocol + "//"
          )),
          ...
          try {
            (a.href = p.url),
              (a.href = a.href),
              (p.crossDomain =
                jd.protocol + "//" + jd.host != a.protocol + "//" + a.host);
          } catch (e) {
            p.crossDomain = !0;
          }
        }
        ...
        p.hasContent
          ? p.data &&
            ...
            (p.data = p.data.replace(Ad, "+"))
          : (($ = p.url.slice(i.length)),
            p.data &&
              (p.processData || "string" == typeof p.data) &&
              ((i += (wd.test(i) ? "&" : "?") + p.data), delete p.data),
            !1 === p.cache &&
              ((i = i.replace(Nd, "$1")),
              ($ = (wd.test(i) ? "&" : "?") + "_=" + Sd.guid++ + $)),
            (p.url = i + $)),
        ...
        T.setRequestHeader(
          ...
          p.dataTypes[0] && p.accepts[p.dataTypes[0]]
            ? p.accepts[p.dataTypes[0]] +
                ("*" !== p.dataTypes[0] ? ", " + Hd + "; q=0.01" : "")
            : p.accepts["*"]
        ),
        p.headers))
          T.setRequestHeader(u, p.headers[u]);
        if (p.beforeSend && (!1 === p.beforeSend.call(f, T, p) || l))
          return T.abort();
        if (
          ((C = "abort"),
          v.add(p.complete),
          ...
          if (((T.readyState = 1), c && h.trigger("ajaxSend", [T, p]), l))
            return T;
          p.async &&
            p.timeout > 0 &&
        ...
        function x(d, t, r, a) {
          ...
          l ||
            ...
            r &&
              (b = (function (e, d, t) {
                for (
                  var n, i, o, r, s = e.contents, a = e.dataTypes;
                  "*" === a[0];

                )
                  a.shift(),
                    void 0 === n &&
                      (n = e.mimeType || d.getResponseHeader("Content-Type"));
                if (n)
                  for (i in s)
                    if (s[i] && s[i].test(n)) {
                      a.unshift(i);
                ...
                if (o) return o !== a[0] && a.unshift(o), t[o];
              })(p, T, r)),
            !u &&
            ...
            (b = (function (e, d, t, n) {
              ...
              for (o = c.shift(); o; )
                if (
                  (e.responseFields[o] && (t[e.responseFields[o]] = d),
                  !a && n && e.dataFilter && (d = e.dataFilter(d, e.dataType)),
                  (a = o),
                  (o = c.shift()))
                )
                  if ("*" === o) o = a;
            ...
            u
              ? (p.ifModified &&
                ...
                204 === d || "HEAD" === p.type
                  ...
                  : 304 === d
                  ? (C = "notmodified")
                  : ((C = b.state), ($ = b.data), (u = !(g = b.error))))
              : ((g = C), (!d && C) || ((C = "error"), d < 0 && (d = 0))),
            (T.status = d),
            (T.statusText = (t || C) + ""),
            u ? y.resolveWith(f, [$, C, T]) : y.rejectWith(f, [T, C, g]),
            T.statusCode(m),
            (m = void 0),
            c && h.trigger(u ? "ajaxSuccess" : "ajaxError", [T, p, u ? $ : g]),
            v.fireWith(f, [T, C]),
            c &&
      ...
      getJSON: function (e, d, t) {
        return S.get(e, d, t, "json");
      },
      getScript: function (e, d) {
        return S.get(e, void 0, d, "script");
      },
    }),
    S.each(["get", "post"], function (e, d) {
      S[d] = function (e, t, n, i) {
        return (
          f(t) && ((i = i || n), (n = t), (t = void 0)),
          S.ajax(
            S.extend(
              { url: e, type: d, dataType: i, data: t, success: n },
              S.isPlainObject(e) && e
            )
          )
        );
    ...
    S.ajaxPrefilter(function (e) {
      ...
      for (d in e.headers)
        "content-type" === d.toLowerCase() &&
          (e.contentType = e.headers[d] || "");
    }),
    (S._evalUrl = function (e, d, t) {
      return S.ajax({
        url: e,
        type: "GET",
        dataType: "script",
    ...
    S.fn.extend({
      wrapAll: function (e) {
        ...
        return (
          this[0] &&
            (f(e) && (e = e.call(this[0])),
            (d = S(e, this[0].ownerDocument).eq(0).clone(!0)),
      ...
      wrapInner: function (e) {
        return f(e)
          ? this.each(function (d) {
              S(this).wrapInner(e.call(this, d));
            })
          : this.each(function () {
              var d = S(this),
                t = d.contents();
              t.length ? t.wrapAll(e) : d.append(e);
            });
      },
      wrap: function (e) {
        var d = f(e);
        return this.each(function (t) {
          S(this).wrapAll(d ? e.call(this, t) : e);
        });
      },
      unwrap: function (e) {
        return (
  ...
  var Bd = { 0: 200, 1223: 204 },
    Fd = S.ajaxSettings.xhr();
  (p.cors = !!Fd && "withCredentials" in Fd),
    (p.ajax = Fd = !!Fd),
    S.ajaxTransport(function (d) {
      var t, n;
      if (p.cors || (Fd && !d.crossDomain))
        return {
          send: function (i, o) {
            var r,
              s = d.xhr();
            if (
              (s.open(d.type, d.url, d.async, d.username, d.password),
              d.xhrFields)
            )
              for (r in d.xhrFields) s[r] = d.xhrFields[r];
            for (r in (d.mimeType &&
              s.overrideMimeType &&
              s.overrideMimeType(d.mimeType),
            d.crossDomain ||
              i["X-Requested-With"] ||
  ...
  S.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Wd.pop() || S.expando + "_" + Sd.guid++;
      return (this[e] = !0), e;
    },
  }),
    S.ajaxPrefilter("json jsonp", function (d, t, n) {
      var i,
        o,
        r,
        s =
          ...
          (Ud.test(d.url)
            ...
            : "string" == typeof d.data &&
              ...
              Ud.test(d.data) &&
              "data");
      if (s || "jsonp" === d.dataTypes[0])
        return (
          (i = d.jsonpCallback =
            f(d.jsonpCallback) ? d.jsonpCallback() : d.jsonpCallback),
          s
            ? (d[s] = d[s].replace(Ud, "$1" + i))
            : !1 !== d.jsonp &&
              (d.url += (wd.test(d.url) ? "&" : "?") + d.jsonp + "=" + i),
          ...
          n.always(function () {
            void 0 === o ? S(e).removeProp(i) : (e[i] = o),
              d[i] && ((d.jsonpCallback = t.jsonpCallback), Wd.push(i)),
              r && f(o) && o(r[0]),
              (r = o = void 0);
          }),
          "script"
    ...
    (S.parseHTML = function (e, d, t) {
      return "string" != typeof e
        ? []
        : ("boolean" == typeof d && ((t = d), (d = !1)),
          d ||
    ...
    (S.fn.load = function (e, d, t) {
      var n,
        ...
        s = e.indexOf(" ");
      return (
        s > -1 && ((n = fd(e.slice(s))), (e = e.slice(0, s))),
        f(d)
          ? ((t = d), (d = void 0))
          : d && "object" == typeof d && (i = "POST"),
        r.length > 0 &&
          S.ajax({ url: e, type: i || "GET", dataType: "html", data: d })
            .done(function (e) {
              (o = arguments),
            ...
            .always(
              t &&
                function (e, d) {
                  r.each(function () {
                    t.apply(this, o || [e.responseText, d, e]);
                  });
                }
            ),
        this
    ...
    (S.expr.pseudos.animated = function (e) {
      return S.grep(S.timers, function (d) {
        return e === d.elem;
      }).length;
    }),
    (S.offset = {
      setOffset: function (e, d, t) {
        ...
        "static" === l && (e.style.position = "relative"),
          ...
          (o = S.css(e, "top")),
          (a = S.css(e, "left")),
          ("absolute" === l || "fixed" === l) && (o + a).indexOf("auto") > -1
            ? ((r = (n = c.position()).top), (i = n.left))
            : ((r = parseFloat(o) || 0), (i = parseFloat(a) || 0)),
          f(d) && (d = d.call(e, t, S.extend({}, s))),
          null != d.top && (u.top = d.top - s.top + r),
          null != d.left && (u.left = d.left - s.left + i),
          "using" in d ? d.using.call(e, u) : c.css(u);
      },
    }),
    S.fn.extend({
      offset: function (e) {
        ...
        return n
          ? n.getClientRects().length
            ? ((d = n.getBoundingClientRect()),
              ...
              { top: d.top + t.pageYOffset, left: d.left + t.pageXOffset })
            : { top: 0, left: 0 }
          : void 0;
      },
      position: function () {
        if (this[0]) {
          var e,
            ...
            n = this[0],
            i = { top: 0, left: 0 };
          if ("fixed" === S.css(n, "position")) d = n.getBoundingClientRect();
          else {
            for (
              d = this.offset(),
                t = n.ownerDocument,
                e = n.offsetParent || t.documentElement;
              e &&
          ...
          return {
            top: d.top - i.top - S.css(n, "marginTop", !0),
            left: d.left - i.left - S.css(n, "marginLeft", !0),
          };
        }
      },
        ...
        S.fn[e] = function (n) {
          return F(
            ...
            function (e, n, i) {
              var o;
              if (
                (h(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView),
                void 0 === i)
              )
                return o ? o[d] : e[n];
              o
                ? o.scrollTo(t ? o.pageXOffset : i, t ? i : o.pageYOffset)
                : (e[n] = i);
            },
            e,
            n,
    ...
    S.each(["top", "left"], function (e, d) {
      S.cssHooks[d] = We(p.pixelPosition, function (e, t) {
        if (t)
          return (t = Fe(e, d)), Ie.test(t) ? S(e).position()[d] + "px" : t;
      });
    }),
    S.each({ Height: "height", Width: "width" }, function (e, d) {
      S.each(
        { padding: "inner" + e, content: d, "": "outer" + e },
        function (t, n) {
          S.fn[n] = function (i, o) {
            var r = arguments.length && (t || "boolean" != typeof i),
    ...
    S.fn.extend({
      bind: function (e, d, t) {
        return this.on(e, null, d, t);
      },
      unbind: function (e, d) {
        return this.off(e, null, d);
      },
      delegate: function (e, d, t, n) {
        return this.on(d, e, t, n);
      },
      ...
      hover: function (e, d) {
        return this.mouseenter(e).mouseleave(d || e);
      },
    }),
    S.each(
  ...
  var zd = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;
  (S.proxy = function (e, d) {
    var t, n, o;
    if (("string" == typeof d && ((t = e[d]), (d = e), (e = t)), f(e)))
      return (
        (n = i.call(arguments, 2)),
        (o = function () {
          return e.apply(d || this, n.concat(i.call(arguments)));
        }),
    ...
    (S.isNumeric = function (e) {
      var d = S.type(e);
      return ("number" === d || "string" === d) && !isNaN(e - parseFloat(e));
    }),
    (S.trim = function (e) {
      return null == e ? "" : (e + "").replace(zd, "$1");
    }),
  ...
  var Gd = e.jQuery,
    Kd = e.$;
  return (
    (S.noConflict = function (d) {
      return e.$ === S && (e.$ = Kd), d && e.jQuery === S && (e.jQuery = Gd), S;
    }),
    void 0 === d && (e.jQuery = e.$ = S),
    S
  );
}),
  (function (e) {
    ...
    (d = 0),
      (t = function (t, n) {
        ...
        (o.defaults = {
          ...
          (o.windowTimer = null),
          (i = e(t).data("slick") || {}),
          (o.options = e.extend({}, o.defaults, n, i)),
          ...
          i.unload(),
            "number" == typeof t
              ? 0 === t && 0 === i.$slides.length
                ? e(d).appendTo(i.$slideTrack)
                : n
                ? e(d).insertBefore(i.$slides.eq(t))
                : e(d).insertAfter(i.$slides.eq(t))
              : !0 === n
              ? e(d).prependTo(i.$slideTrack)
              : e(d).appendTo(i.$slideTrack),
            (i.$slides = i.$slideTrack.children(this.options.slide)),
            i.$slideTrack.children(this.options.slide).detach(),
            i.$slideTrack.append(i.$slides),
            i.$slides.each(function (d, t) {
              e(t).attr("data-slick-index", d);
            }),
      ...
      (t.prototype.animateHeight = function () {
        ...
        if (
          ...
          var d = e.$slides.eq(e.currentSlide).outerHeight(!0);
          e.$list.animate({ height: d }, e.options.speed);
        }
      }),
      (t.prototype.animateSlide = function (d, t) {
        var n = {},
          i = this;
        i.animateHeight(),
          !0 === i.options.rtl && !1 === i.options.vertical && (d = -d),
          !1 === i.transformsEnabled
            ...
            : (i.applyTransition(),
              (d = Math.ceil(d)),
              !1 === i.options.vertical
                ? (n[i.animType] = "translate3d(" + d + "px, 0px, 0px)")
                : (n[i.animType] = "translate3d(0px," + d + "px, 0px)"),
              i.$slideTrack.css(n),
              t &&
                setTimeout(function () {
      ...
      (t.prototype.getNavTarget = function () {
        ...
        return d && null !== d && (d = e(d).not(this.$slider)), d;
      }),
      (t.prototype.asNavFor = function (d) {
        var t = this.getNavTarget();
        null !== t &&
          "object" == typeof t &&
          t.each(function () {
            var t = e(this).slick("getSlick");
            t.unslicked || t.slideHandler(d, !0);
          });
      }),
      (t.prototype.applyTransition = function (e) {
        ...
        !1 === d.options.fade
          ? (t[d.transitionType] =
              ...
              d.options.cssEase)
          : (t[d.transitionType] =
              "opacity " + d.options.speed + "ms " + d.options.cssEase),
          !1 === d.options.fade ? d.$slideTrack.css(t) : d.$slides.eq(e).css(t);
      }),
      ...
      (t.prototype.autoPlayIterator = function () {
        var e = this,
          d = e.currentSlide + e.options.slidesToScroll;
        e.paused ||
          e.interrupted ||
          e.focussed ||
      ...
      (t.prototype.buildArrows = function () {
        var d = this;
        !0 === d.options.arrows &&
          ((d.$prevArrow = e(d.options.prevArrow).addClass("slick-arrow")),
          (d.$nextArrow = e(d.options.nextArrow).addClass("slick-arrow")),
          d.slideCount > d.options.slidesToShow
            ? (d.$prevArrow
              ...
              d.$nextArrow
                .removeClass("slick-hidden")
                .removeAttr("aria-hidden tabindex"),
              d.htmlExpr.test(d.options.prevArrow) &&
                d.$prevArrow.prependTo(d.options.appendArrows),
              d.htmlExpr.test(d.options.nextArrow) &&
                d.$nextArrow.appendTo(d.options.appendArrows),
        ...
        if (!0 === n.options.dots && n.slideCount > n.options.slidesToShow) {
          for (
            n.$slider.addClass("slick-dotted"),
              t = e("<ul />").addClass(n.options.dotsClass),
              d = 0;
            d <= n.getDotCount();
            d += 1
          )
            t.append(
              e("<li />").append(n.options.customPaging.call(this, n, d))
            );
      ...
      (t.prototype.buildOut = function () {
        var d = this;
        (d.$slides = d.$slider
          .children(d.options.slide + ":not(.slick-cloned)")
          .addClass("slick-slide")),
          (d.slideCount = d.$slides.length),
          d.$slides.each(function (d, t) {
            e(t)
              .attr("data-slick-index", d)
              .data("originalStyling", e(t).attr("style") || "");
          }),
          d.$slider.addClass("slick-slider"),
          (d.$slideTrack =
            0 === d.slideCount
              ? e('<div class="slick-track"/>').appendTo(d.$slider)
              : d.$slides.wrapAll('<div class="slick-track"/>').parent()),
          (d.$list = d.$slideTrack.wrap('<div class="slick-list"/>').parent()),
          d.$slideTrack.css("opacity", 0),
          (!0 !== d.options.centerMode && !0 !== d.options.swipeToSlide) ||
            (d.options.slidesToScroll = 1),
          e("img[data-lazy]", d.$slider).not("[src]").addClass("slick-loading"),
          d.setupInfinite(),
          d.buildArrows(),
          d.buildDots(),
          d.updateDots(),
          d.setSlideClasses(
            "number" == typeof d.currentSlide ? d.currentSlide : 0
          ),
          !0 === d.options.draggable && d.$list.addClass("draggable");
      }),
      (t.prototype.buildRows = function () {
        ...
        if (
          ...
          for (
            ...
            for (d = 0; d < s.options.rows; d++) {
              var l = document.createElement("div");
              for (t = 0; t < s.options.slidesPerRow; t++) {
                var c = e * r + (d * s.options.slidesPerRow + t);
      ...
      (t.prototype.checkResponsive = function (d, t) {
        var n,
          i,
          o,
          r = this,
        ...
        if (
          ...
          null !== i
              ...
              ? (i !== r.activeBreakpoint || t) &&
                ...
                "unslick" === r.breakpointSettings[i]
                  ...
                  : ((r.options = e.extend(
                    ...
                    !0 === d && (r.currentSlide = r.options.initialSlide),
                    r.refresh(d)),
                (s = i))
              : ((r.activeBreakpoint = i),
                "unslick" === r.breakpointSettings[i]
            ...
            : null !== r.activeBreakpoint &&
              ...
              r.refresh(d),
              (s = i)),
            d || !1 === s || r.$slider.trigger("breakpoint", [r, s]);
        }
      }),
      (t.prototype.changeSlide = function (d, t) {
        var n,
          i,
          o = this,
          r = e(d.currentTarget);
        switch (
          (r.is("a") && d.preventDefault(),
          ...
          case "index":
            var s =
              0 === d.data.index
                ? 0
                : d.data.index || r.index() * o.options.slidesToScroll;
      ...
      (t.prototype.checkNavigable = function (e) {
        var d, t;
        if (((t = 0), e > (d = this.getNavigableIndexes())[d.length - 1]))
          e = d[d.length - 1];
        else
          for (var n in d) {
            if (e < d[n]) {
      ...
      (t.prototype.cleanUpEvents = function () {
        ...
        d.options.dots &&
          null !== d.$dots &&
          (e("li", d.$dots)
            .off("click.slick", d.changeSlide)
            .off("mouseenter.slick", e.proxy(d.interrupt, d, !0))
            .off("mouseleave.slick", e.proxy(d.interrupt, d, !1)),
          !0 === d.options.accessibility &&
            d.$dots.off("keydown.slick", d.keyHandler)),
          d.$slider.off("focus.slick blur.slick"),
          !0 === d.options.arrows &&
            d.slideCount > d.options.slidesToShow &&
            (d.$prevArrow && d.$prevArrow.off("click.slick", d.changeSlide),
            d.$nextArrow && d.$nextArrow.off("click.slick", d.changeSlide),
            !0 === d.options.accessibility &&
              (d.$prevArrow && d.$prevArrow.off("keydown.slick", d.keyHandler),
          ...
          e(document).off(d.visibilityChange, d.visibility),
          d.cleanUpSlideEvents(),
          !0 === d.options.accessibility &&
            d.$list.off("keydown.slick", d.keyHandler),
          !0 === d.options.focusOnSelect &&
            e(d.$slideTrack).children().off("click.slick", d.selectHandler),
          e(window).off(
            "orientationchange.slick.slick-" + d.instanceUid,
            d.orientationChange
          ),
          e(window).off("resize.slick.slick-" + d.instanceUid, d.resize),
          e("[draggable!=true]", d.$slideTrack).off(
            "dragstart",
            d.preventDefault
          ),
          e(window).off("load.slick.slick-" + d.instanceUid, d.setPosition);
      }),
      (t.prototype.cleanUpSlideEvents = function () {
        var d = this;
        d.$list.off("mouseenter.slick", e.proxy(d.interrupt, d, !0)),
          d.$list.off("mouseleave.slick", e.proxy(d.interrupt, d, !1));
      }),
      (t.prototype.cleanUpRows = function () {
        var e,
          d = this;
        d.options.rows > 0 &&
          ((e = d.$slides.children().children()).removeAttr("style"),
          d.$slider.empty().append(e));
      }),
      ...
      (t.prototype.destroy = function (d) {
        var t = this;
        t.autoPlayClear(),
          (t.touchObject = {}),
          t.cleanUpEvents(),
      ...
      (t.prototype.fadeSlide = function (e, d) {
        var t = this;
        !1 === t.cssTransitions
          ? (t.$slides.eq(e).css({ zIndex: t.options.zIndex }),
            t.$slides
              .eq(e)
              .animate({ opacity: 1 }, t.options.speed, t.options.easing, d))
          : (t.applyTransition(e),
            t.$slides.eq(e).css({ opacity: 1, zIndex: t.options.zIndex }),
            d &&
              setTimeout(function () {
                t.disableTransition(e), d.call();
              }, t.options.speed));
      }),
      ...
      (t.prototype.focusHandler = function () {
        ...
        d.$slider
          ...
          .on("focus.slick blur.slick", "*", function (t) {
            ...
            var n = e(this);
            setTimeout(function () {
              d.options.pauseOnFocus &&
                ((d.focussed = n.is(":focus")), d.autoPlay());
            }, 0);
          });
      }),
      ...
      (t.prototype.getNavigableIndexes = function () {
        ...
        for (
          !1 === d.options.infinite
            ? (e = d.slideCount)
            : ((t = -1 * d.options.slidesToScroll),
              (n = -1 * d.options.slidesToScroll),
              (e = 2 * d.slideCount));
          t < e;

        )
          i.push(t),
            (t = n + d.options.slidesToScroll),
            (n +=
      ...
      (t.prototype.getSlideCount = function () {
        ...
        return (
          ...
          !0 === n.options.swipeToSlide
            ? (n.$slideTrack.find(".slick-slide").each(function (i, o) {
                if (o.offsetLeft - t + e(o).outerWidth() / 2 > -1 * n.swipeLeft)
                  return (d = o), !1;
              }),
              Math.abs(e(d).attr("data-slick-index") - n.currentSlide) || 1)
      ...
      (t.prototype.init = function (d) {
        ...
        e(t.$slider).hasClass("slick-initialized") ||
          ...
          t.checkResponsive(!0),
          t.focusHandler()),
          d && t.$slider.trigger("init", [t]),
          !0 === t.options.accessibility && t.initADA(),
          t.options.autoplay && ((t.paused = !1), t.autoPlay());
      }),
      (t.prototype.initADA = function () {
        var d = this,
          t = Math.ceil(d.slideCount / d.options.slidesToShow),
          n = d.getNavigableIndexes().filter(function (e) {
            return e >= 0 && e < d.slideCount;
          });
        d.$slides
          .add(d.$slideTrack.find(".slick-cloned"))
          .attr({ "aria-hidden": "true", tabindex: "-1" })
          .find("a, input, button, select")
          .attr({ tabindex: "-1" }),
          null !== d.$dots &&
            (d.$slides
              .not(d.$slideTrack.find(".slick-cloned"))
              .each(function (t) {
                var i = n.indexOf(t);
                if (
                  (e(this).attr({
                    role: "tabpanel",
                    id: "slick-slide" + d.instanceUid + t,
                    tabindex: -1,
                  }),
                  -1 !== i)
                ) {
                  var o = "slick-slide-control" + d.instanceUid + i;
            ...
            d.$dots
              ...
              .each(function (i) {
                ...
                e(this).attr({ role: "presentation" }),
                  e(this)
                    ...
                    .attr({
                      role: "tab",
                      id: "slick-slide-control" + d.instanceUid + i,
                      "aria-controls": "slick-slide" + d.instanceUid + o,
                      "aria-label": i + 1 + " of " + t,
                      "aria-selected": null,
                      tabindex: "-1",
                    });
              ...
              .end());
        for (var i = d.currentSlide, o = i + d.options.slidesToShow; i < o; i++)
          d.options.focusOnChange
            ? d.$slides.eq(i).attr({ tabindex: "0" })
            : d.$slides.eq(i).removeAttr("tabindex");
        d.activateADA();
      }),
      ...
      (t.prototype.initDotEvents = function () {
        ...
        !0 === d.options.dots &&
          ...
          !0 === d.options.accessibility &&
            d.$dots.on("keydown.slick", d.keyHandler)),
          !0 === d.options.dots &&
            !0 === d.options.pauseOnDotsHover &&
            d.slideCount > d.options.slidesToShow &&
            e("li", d.$dots)
              .on("mouseenter.slick", e.proxy(d.interrupt, d, !0))
              .on("mouseleave.slick", e.proxy(d.interrupt, d, !1));
      }),
      (t.prototype.initSlideEvents = function () {
        var d = this;
        d.options.pauseOnHover &&
          (d.$list.on("mouseenter.slick", e.proxy(d.interrupt, d, !0)),
          d.$list.on("mouseleave.slick", e.proxy(d.interrupt, d, !1)));
      }),
      (t.prototype.initializeEvents = function () {
        ...
        d.initArrowEvents(),
          ...
          e(document).on(d.visibilityChange, e.proxy(d.visibility, d)),
          !0 === d.options.accessibility &&
            d.$list.on("keydown.slick", d.keyHandler),
          !0 === d.options.focusOnSelect &&
            e(d.$slideTrack).children().on("click.slick", d.selectHandler),
          e(window).on(
            "orientationchange.slick.slick-" + d.instanceUid,
            e.proxy(d.orientationChange, d)
          ),
          e(window).on(
            "resize.slick.slick-" + d.instanceUid,
            e.proxy(d.resize, d)
          ),
          e("[draggable!=true]", d.$slideTrack).on(
            "dragstart",
            d.preventDefault
          ),
          e(window).on("load.slick.slick-" + d.instanceUid, d.setPosition),
          e(d.setPosition);
      }),
      ...
      (t.prototype.keyHandler = function (e) {
        ...
        e.target.tagName.match("TEXTAREA|INPUT|SELECT") ||
          (37 === e.keyCode && !0 === d.options.accessibility
            ? d.changeSlide({
                data: { message: !0 === d.options.rtl ? "next" : "previous" },
              })
            : 39 === e.keyCode &&
              !0 === d.options.accessibility &&
              d.changeSlide({
                data: { message: !0 === d.options.rtl ? "previous" : "next" },
              }));
      }),
      (t.prototype.lazyLoad = function () {
        var d,
          ...
          i = this;
        function o(d) {
          e("img[data-lazy]", d).each(function () {
            var d = e(this),
            ...
            (r.onload = function () {
              d.animate({ opacity: 0 }, 100, function () {
                n && (d.attr("srcset", n), o && d.attr("sizes", o)),
                  d.attr("src", t).animate({ opacity: 1 }, 200, function () {
                    d.removeAttr(
                      "data-lazy data-srcset data-sizes"
                    ).removeClass("slick-loading");
                  }),
                  i.$slider.trigger("lazyLoaded", [i, d, t]);
              });
            }),
              (r.onerror = function () {
                d
                  ...
                  i.$slider.trigger("lazyLoadError", [i, d, t]);
              }),
              (r.src = t);
          });
        }
        if (
          (!0 === i.options.centerMode
            ...
            : ((t = i.options.infinite
              ...
              !0 === i.options.fade &&
                (t > 0 && t--, n <= i.slideCount && n++)),
          (d = i.$slider.find(".slick-slide").slice(t, n)),
          "anticipated" === i.options.lazyLoad)
        )
          for (
            var r = t - 1, s = n, a = i.$slider.find(".slick-slide"), l = 0;
            l < i.options.slidesToScroll;
            l++
          )
            r < 0 && (r = i.slideCount - 1),
              (d = (d = d.add(a.eq(r))).add(a.eq(s))),
              r--,
              s++;
        o(d),
      ...
      (t.prototype.postSlide = function (d) {
        var t = this;
        t.unslicked ||
          (t.$slider.trigger("afterChange", [t, d]),
          (t.animating = !1),
      ...
      (t.prototype.progressiveLazyLoad = function (d) {
        d = d || 1;
        var t,
          n,
          i,
      ...
      (t.prototype.refresh = function (d) {
        ...
        (n = i.slideCount - i.options.slidesToShow),
          ...
          (t = i.currentSlide),
          i.destroy(!0),
          e.extend(i, i.initials, { currentSlide: t }),
          i.init(),
          d || i.changeSlide({ data: { message: "index", index: t } }, !1);
      }),
      (t.prototype.registerBreakpoints = function () {
        ...
        if ("array" === e.type(o) && o.length) {
          for (d in ((i.respondTo = i.options.respondTo || "window"), o))
            if (((n = i.breakpoints.length - 1), o.hasOwnProperty(d))) {
              for (t = o[d].breakpoint; n >= 0; )
                i.breakpoints[n] &&
                  i.breakpoints[n] === t &&
                  i.breakpoints.splice(n, 1),
                  n--;
              i.breakpoints.push(t), (i.breakpointSettings[t] = o[d].settings);
            }
          i.breakpoints.sort(function (e, d) {
            return i.options.mobileFirst ? e - d : d - e;
          });
        }
      }),
      (t.prototype.reinit = function () {
        var d = this;
        (d.$slides = d.$slideTrack
          .children(d.options.slide)
          .addClass("slick-slide")),
          (d.slideCount = d.$slides.length),
          d.currentSlide >= d.slideCount &&
            0 !== d.currentSlide &&
            (d.currentSlide = d.currentSlide - d.options.slidesToScroll),
      ...
      (t.prototype.resize = function () {
        var d = this;
        e(window).width() !== d.windowWidth &&
          (clearTimeout(d.windowDelay),
          (d.windowDelay = window.setTimeout(function () {
            (d.windowWidth = e(window).width()),
              d.checkResponsive(),
      ...
      (t.prototype.setCSS = function (e) {
        var d,
          ...
          i = {};
        !0 === n.options.rtl && (e = -e),
          (d = "left" == n.positionProp ? Math.ceil(e) + "px" : "0px"),
          (t = "top" == n.positionProp ? Math.ceil(e) + "px" : "0px"),
          (i[n.positionProp] = e),
          !1 === n.transformsEnabled
            ? n.$slideTrack.css(i)
            : ((i = {}),
              !1 === n.cssTransitions
                ? ((i[n.animType] = "translate(" + d + ", " + t + ")"),
                  n.$slideTrack.css(i))
                : ((i[n.animType] = "translate3d(" + d + ", " + t + ", 0px)"),
                  n.$slideTrack.css(i)));
      }),
      (t.prototype.setDimensions = function () {
        ...
        var d = e.$slides.first().outerWidth(!0) - e.$slides.first().width();
        !1 === e.options.variableWidth &&
          e.$slideTrack.children(".slick-slide").width(e.slideWidth - d);
      }),
          ...
          if (
            ...
            for (t in i)
              if ("array" !== e.type(r.options.responsive))
                ...
                for (d = r.options.responsive.length - 1; d >= 0; )
                  r.options.responsive[d].breakpoint === i[t].breakpoint &&
                    r.options.responsive.splice(d, 1),
                    d--;
      ...
      (t.prototype.setProps = function () {
        ...
        (e.positionProp = !0 === e.options.vertical ? "top" : "left"),
          ...
          void 0 !== d.msTransform &&
            ...
            void 0 === d.msTransform && (e.animType = !1)),
          void 0 !== d.transform &&
            !1 !== e.animType &&
      ...
      (t.prototype.setSlideClasses = function (e) {
        ...
        if (
          ...
          (d = Math.floor(o.options.slidesToShow / 2)),
            !0 === o.options.infinite &&
              (e >= d && e <= o.slideCount - 1 - d
                ? o.$slides
                    .slice(e - d + r, e + d + 1)
              ...
              0 === e
                ? t
                    .eq(t.length - 1 - o.options.slidesToShow)
                    .addClass("slick-center")
                : e === o.slideCount - 1 &&
                  t.eq(o.options.slidesToShow).addClass("slick-center")),
      ...
      (t.prototype.selectHandler = function (d) {
        var t = this,
          n = e(d.target).is(".slick-slide")
            ? e(d.target)
            : e(d.target).parents(".slick-slide"),
          i = parseInt(n.attr("data-slick-index"));
        i || (i = 0),
          t.slideCount <= t.options.slidesToShow
            ? t.slideHandler(i, !1, !0)
            : t.slideHandler(i);
      }),
      (t.prototype.slideHandler = function (e, d, t) {
        var n,
          i,
          o,
          r,
      ...
      (t.prototype.swipeDirection = function () {
        ...
        return (
          ...
          (d = i.touchObject.startY - i.touchObject.curY),
          (t = Math.atan2(d, e)),
          (n = Math.round((180 * t) / Math.PI)) < 0 && (n = 360 - Math.abs(n)),
      ...
      (t.prototype.swipeHandler = function (e) {
        ...
        if (
          !(
            !1 === d.options.swipe ||
            ("ontouchend" in document && !1 === d.options.swipe) ||
            (!1 === d.options.draggable && -1 !== e.type.indexOf("mouse"))
          )
        )
          switch (
            ...
            !0 === d.options.verticalSwiping &&
              (d.touchObject.minSwipe =
                d.listHeight / d.options.touchThreshold),
            e.data.action)
          ) {
            case "start":
              d.swipeStart(e);
      ...
      (t.prototype.swipeMove = function (e) {
        ...
        return (
          ...
          !(!s.dragging || s.scrolling || (o && 1 !== o.length)) &&
            ...
            !s.options.verticalSwiping && !s.swiping && r > 4
              ? ((s.scrolling = !0), !1)
              : (!0 === s.options.verticalSwiping &&
                ...
                !1 === s.options.infinite &&
                  ((0 === s.currentSlide && "right" === t) ||
                    (s.currentSlide >= s.getDotCount() && "left" === t)) &&
                  ((n = s.touchObject.swipeLength * s.options.edgeFriction),
                  (s.touchObject.edgeHit = !0)),
                !1 === s.options.vertical
                  ? (s.swipeLeft = d + n * i)
                  : (s.swipeLeft =
                      d + n * (s.$list.height() / s.listWidth) * i),
                !0 === s.options.verticalSwiping && (s.swipeLeft = d + n * i),
                !0 !== s.options.fade &&
      ...
      (t.prototype.swipeStart = function (e) {
        ...
        void 0 !== e.originalEvent &&
          ...
          (d = e.originalEvent.touches[0]),
          (t.touchObject.startX = t.touchObject.curX =
            void 0 !== d ? d.pageX : e.clientX),
          (t.touchObject.startY = t.touchObject.curY =
            void 0 !== d ? d.pageY : e.clientY),
          (t.dragging = !0);
      }),
      ...
      (t.prototype.unload = function () {
        var d = this;
        e(".slick-cloned", d.$slider).remove(),
      ...
      (t.prototype.unslick = function (e) {
        var d = this;
        d.$slider.trigger("unslick", [d, e]), d.destroy();
      }),
        ...
        for (e = 0; e < r; e++)
          if (
            ("object" == typeof i || void 0 === i
              ? (n[e].slick = new t(n[e], i))
              : (d = n[e].slick[i].apply(n[e].slick, o)),
            void 0 !== d)
          )
            return d;
        return n;
  ...
  (function () {
    ...
    function d(d, t) {
      ...
      var n,
        i = e;
      d[0] in i || void 0 === i.execScript || i.execScript("var " + d[0]);
      ...
      (t.prototype = d.prototype),
        ...
        (e.fa = function (e, t, n) {
          for (
            ...
            i[o - 2] = arguments[o];
          return d.prototype[t].apply(e, i);
        });
    }
    function n(e, d) {
      switch (
    ...
    var i = 1,
      ...
      c = 18;
    function u(e, d) {
      for (this.i = e, this.g = {}, e = 0; e < d.length; e++) {
        var t = d[e];
        this.g[t.g] = t;
      }
    }
    ...
    function p(e, d) {
      for (
        var t = (function (e) {
            return (
              (e = (function (e) {
                const d = [];
                let t = 0;
                for (const n in e) d[t++] = e[n];
                return d;
              })(e.g)).sort(function (e, d) {
                return e.g - d.g;
              }),
              e
            );
        ...
        if (null != d.g[o]) {
          ...
          if (i.m) {
            i = y(d, o);
            for (var s = 0; s < i.length; s++) b(e, o, r ? i[s].clone() : i[s]);
          } else
            (i = f(d, o)),
              r ? ((r = f(e, o)) ? p(r, i) : m(e, o, i.clone())) : m(e, o, i);
        }
      }
    }
    function f(e, d) {
      ...
      if (e.m) {
        if (!(d in e.i)) {
          ...
          if (null != t)
            if (i.m) {
              for (var o = [], r = 0; r < t.length; r++) o[r] = n.i(i, t[r]);
              t = o;
            } else t = n.i(i, t);
          return (e.i[d] = t);
        }
    ...
    function h(e, d, t) {
      var n = f(e, d);
      return e.l[d].m ? n[t || 0] : n;
    }
    function g(e, d) {
      if (null != e.g[d]) e = h(e, d);
      else
        e: {
          if (void 0 === (e = e.l[d]).l)
            if ((d = e.v) === Boolean) e.l = !1;
            else if (d === Number) e.l = 0;
            else {
              if (d !== String) {
                e = new d();
                break e;
    ...
    function b(e, d, t) {
      e.g[d] || (e.g[d] = []), e.g[d].push(t), e.i && delete e.i[d];
    }
    function S(e, d) {
      var t,
        i = [];
      for (t in d) 0 != t && i.push(new n(t, d[t]));
      return new u(e, i);
    }
    function w() {}
    ($.prototype.has = function (e) {
      return null != this.g[e.g];
    }),
      ($.prototype.get = function (e, d) {
        return h(this, e.g, d);
      }),
      ($.prototype.set = function (e, d) {
        m(this, e.g, d);
      }),
      ($.prototype.add = function (e, d) {
        b(this, e.g, d);
      }),
      ($.prototype.clone = function () {
        var e = new this.constructor();
        return e != this && ((e.g = {}), e.i && (e.i = {}), p(e, this)), e;
      }),
      (w.prototype.g = function (e) {
        throw (new e.i(), Error("Unimplemented"));
      }),
      (w.prototype.i = function (e, d) {
        if (11 == e.i || 10 == e.i)
          return d instanceof $ ? d : this.g(e.v.prototype.j(), d);
        if (14 == e.i)
          return "string" == typeof d && C.test(d) && 0 < (e = Number(d))
            ? e
            : d;
        if (!e.u) return d;
        if ((e = e.v) === String) {
          ...
          e === Number &&
          "string" == typeof d &&
          ("Infinity" === d || "-Infinity" === d || "NaN" === d || C.test(d))
        )
          return Number(d);
        return d;
      });
    ...
    t(T, w),
      (T.prototype.g = function (e, d) {
        return ((e = new e.i()).m = this), (e.g = d), (e.i = {}), e;
      }),
      t(x, T),
      (x.prototype.i = function (e, d) {
        return 8 == e.i ? !!d : w.prototype.i.apply(this, arguments);
      }),
      (x.prototype.g = function (e, d) {
        return x.$.g.call(this, e, d);
      }),
      (k.prototype.i = ""),
      (k.prototype.set = function (e) {
        this.i = "" + e;
      }),
      (k.prototype.g = function (e, d, t) {
        if (((this.i += String(e)), null != d))
          for (let e = 1; e < arguments.length; e++) this.i += arguments[e];
        return this;
      }),
          ...
          e ||
            (P = e =
              S(O, {
                ...
                1: { name: "general_desc", h: 11, type: L },
                2: { name: "fixed_line", h: 11, type: L },
                3: { name: "mobile", h: 11, type: L },
                4: { name: "toll_free", h: 11, type: L },
                5: { name: "premium_rate", h: 11, type: L },
                6: { name: "shared_cost", h: 11, type: L },
                7: { name: "personal_number", h: 11, type: L },
                8: { name: "voip", h: 11, type: L },
                21: { name: "pager", h: 11, type: L },
                25: { name: "uan", h: 11, type: L },
                27: { name: "emergency", h: 11, type: L },
                28: { name: "voicemail", h: 11, type: L },
                29: { name: "short_code", h: 11, type: L },
                30: { name: "standard_rate", h: 11, type: L },
                31: { name: "carrier_specific", h: 11, type: L },
                33: { name: "sms_services", h: 11, type: L },
                24: { name: "no_international_dialling", h: 11, type: L },
                ...
                19: { name: "number_format", o: !0, h: 11, type: E },
                20: { name: "intl_number_format", o: !0, h: 11, type: E },
                22: {
    ...
    var q = {
      ...
      B = RegExp("^[+＋]+"),
      F = RegExp("([0-9０-９٠-٩۰-۹])"),
      W = RegExp("[+＋0-9０-９٠-٩۰-۹]"),
      U = /[\\\/] *x/,
      z = RegExp("[^0-9０-９٠-٩۰-۹A-Za-z#]+$"),
      G = /(?:.*?[A-Za-z]){3}.*/,
      K = RegExp(
    ...
    var Z = new RegExp("(?:" + X() + ")$", "i"),
      ...
      Q = /(\$\d)/;
    function ee(e) {
      return !(2 > e.length) && we(J, e);
    }
    function de(e) {
      return we(G, e) ? ie(e, R) : ie(e, q);
    }
    function te(e) {
      var d = de(e.toString());
      (e.i = ""), e.g(d);
    ...
    function ne(e) {
      return null != e && (1 != v(e, 9) || -1 != y(e, 9)[0]);
    }
    function ie(e, d) {
      for (var t, n = new k(), i = e.length, o = 0; o < i; ++o)
        null != (t = d[(t = e.charAt(o)).toUpperCase()]) && n.g(t);
      return n.toString();
    }
    function oe(e) {
      return null != e && isNaN(e) && e.toUpperCase() in j;
    }
    function re(e, d, t) {
      if (0 == h(d, 2) && null != d.g[5]) {
        var n = g(d, 5);
        if (0 < n.length) return n;
      }
      n = g(d, 1);
      var i = ae(d);
      if (0 == t) return le(n, 0, i, "");
      if (!(n in H)) return i;
      (e = se(e, n, he(n))),
        (d =
          null != d.g[3] && 0 != h(d, 3).length
            ? 3 == t
              ? ";ext=" + h(d, 3)
              : null != e.g[13]
              ? h(e, 13) + g(d, 3)
      ...
      e: {
        for (
          var o,
            r = (e = 0 == y(e, 20).length || 2 == t ? y(e, 19) : y(e, 20))
              .length,
            s = 0;
          s < r;
          ++s
          ...
          var a = v((o = e[s]), 3);
          if (
            (0 == a || 0 == i.search(h(o, 3, a - 1))) &&
            we((a = new RegExp(h(o, 1))), i)
          ) {
            e = o;
            break e;
          }
    ...
    function se(e, d, t) {
      return $e(e, "001" == t ? "" + d : t);
    }
    function ae(e) {
      if (null == e.g[2]) return "";
      var d = "" + h(e, 2);
      return null != e.g[4] && h(e, 4) && 0 < g(e, 8)
        ? Array(g(e, 8) + 1).join("0") + d
        : d;
    }
    function le(e, d, t, n) {
      switch (d) {
    ...
    function $e(e, d) {
      ...
      var t = e.g[d];
      if (null == t) {
        if (null == (t = j[d])) return null;
        (t = new x().g(O.j(), t)), (e.g[d] = t);
      }
      return t;
    }
    function pe(e, d) {
      var t = e.length;
      return !(0 < v(d, 9) && -1 == y(d, 9).indexOf(t)) && we(g(d, 2), e);
    }
    function fe(e, d) {
      if (null == d) return null;
      var t = g(d, 1);
      if (null == (t = H[t])) e = null;
    ...
    function ge(e, d, t, n) {
      var i = ce(t, n),
        o = 0 == v(i, 9) ? y(h(t, 1), 9) : y(i, 9);
      if (((i = y(i, 10)), 2 == n)) {
        if (!ne(ce(t, 0))) return ge(e, d, t, 1);
        ne((e = ce(t, 1))) &&
          ((o = o.concat(0 == v(e, 9) ? y(h(t, 1), 9) : y(e, 9))).sort(),
          0 == i.length ? (i = y(e, 10)) : (i = i.concat(y(e, 10))).sort());
      }
      return -1 == o[0]
        ? 5
        : ((d = d.length),
    ...
    function ye(e, d) {
      var t = ae(d);
      return (d = g(d, 1)) in H ? ge(e, t, (d = se(e, d, he(d))), -1) : 1;
    }
    function ve(e, d, t, n, i, o) {
      ...
      if (0 == s.length) r = 20;
        ...
        (s = s.replace(B, "")), (d.i = ""), d.g(de(s)), (r = 1);
      else {
        if (((s = new RegExp(r)), te(d), 0 == (r = d.toString()).search(s))) {
          s = r.match(s)[0].length;
          var a = r.substring(s).match(F);
          a && null != a[1] && 0 < a[1].length && "0" == ie(a[1], q)
            ? (r = !1)
            : ((d.i = ""), d.g(r.substring(s)), (r = !0));
        } else r = !1;
        r = r ? 5 : 20;
      }
      if ((i && m(o, 6, r), 20 != r)) {
        if (2 >= d.i.length) throw Error("Phone number too short after IDD");
        e: {
          if (0 != (e = d.toString()).length && "0" != e.charAt(0))
            for (i = e.length, d = 1; 3 >= d && d <= i; ++d)
              if ((t = parseInt(e.substring(0, d), 10)) in H) {
                n.g(e.substring(d)), (n = t);
                break e;
              }
          n = 0;
        }
        if (0 != n) return m(o, 1, n), n;
        throw Error("Invalid country calling code");
      }
      return null != t &&
        ((s = "" + (r = g(t, 10))),
        0 == (a = d.toString()).lastIndexOf(s, 0) &&
          ((s = new k(a.substring(s.length))),
          (a = h(t, 1)),
          (a = new RegExp(g(a, 2))),
          me(s, t, null),
          (s = s.toString()),
          (!we(a, d.toString()) && we(a, s)) ||
            3 == ge(e, d.toString(), t, -1)))
        ? (n.g(s), i && m(o, 6, 10), m(o, 1, r), r)
        : (m(o, 1, 0), 0);
    }
    function me(e, d, t) {
      var n = e.toString(),
      ...
      if (0 != i && null != o && 0 != o.length) {
        var r = new RegExp("^(?:" + o + ")");
        if ((i = r.exec(n))) {
          var s = we((o = new RegExp(g(h(d, 1), 2))), n),
            a = i.length - 1;
          null == (d = h(d, 16)) ||
          0 == d.length ||
          null == i[a] ||
          0 == i[a].length
            ? (s && !we(o, n.substring(i[0].length))) ||
              (null != t && 0 < a && null != i[a] && t.g(i[1]),
              e.set(n.substring(i[0].length)))
            : ((n = n.replace(r, d)),
              (!s || we(o, n)) && (null != t && 0 < a && t.g(i[1]), e.set(n)));
        }
      }
    }
    function be(e, d, t) {
      if (!oe(t) && 0 < d.length && "+" != d.charAt(0))
        throw Error("Invalid country calling code");
      return Se(e, d, t, !0);
    }
    function Se(e, d, t, n) {
      ...
      var i = new k(),
        o = d.indexOf(";phone-context=");
      if (-1 === o) o = null;
      else if ((o += 15) >= d.length) o = "";
      else {
        var r = d.indexOf(";", o);
        o = -1 !== r ? d.substring(o, r) : d.substring(o);
      }
      var s = o;
      if (
        (null == s
          ...
          : 0 === s.length
          ? (r = !1)
          : ((r = K.exec(s)), (s = V.exec(s)), (r = null !== r || null !== s)),
        !r)
      )
        throw Error("The string supplied did not seem to be a phone number");
      if (
        (null != o
          ? ("+" === o.charAt(0) && i.g(o),
            (o = d.indexOf("tel:")),
            i.g(d.substring(0 <= o ? o + 4 : 0, d.indexOf(";phone-context="))))
          : ((o = i.g),
            0 <= (s = (r = d ?? "").search(W))
              ? 0 <=
                  (s = (r = (r = r.substring(s)).replace(z, "")).search(U)) &&
                (r = r.substring(0, s))
              : (r = ""),
            o.call(i, r)),
        0 < (r = (o = i.toString()).indexOf(";isub=")) &&
          ((i.i = ""), i.g(o.substring(0, r))),
        !ee(i.toString()))
      )
        throw Error("The string supplied did not seem to be a phone number");
      if (
        ((o = i.toString()),
        !(oe(t) || (null != o && 0 < o.length && B.test(o))))
      )
        throw Error("Invalid country calling code");
      (o = new D()), n && m(o, 5, d);
      e: {
        if (0 <= (r = (d = i.toString()).search(Z)) && ee(d.substring(0, r)))
          for (var a = (s = d.match(Z)).length, l = 1; l < a; ++l)
            if (null != s[l] && 0 < s[l].length) {
              (i.i = ""), i.g(d.substring(0, r)), (d = s[l]);
              break e;
            }
        d = "";
      }
      ...
      try {
        ...
        if ("Invalid country calling code" != t.message || !B.test(a)) throw t;
        if (0 == (s = ve(e, (a = a.replace(B, "")), r, d, n, o))) throw t;
      }
      if (
        (0 != s
          ? (i = he(s)) != t && (r = se(e, s, i))
          : (te(i),
            ...
            null != t
              ? m(o, 1, (s = g(r, 10)))
              : n && (delete o.g[6], o.i && delete o.i[6])),
        2 > d.i.length)
      )
      ...
      if (
        (null != r &&
          ((t = new k()),
          me((i = new k(d.toString())), r, t),
          2 != (e = ge(e, i.toString(), r, -1)) &&
            4 != e &&
            5 != e &&
            ((d = i), n && 0 < t.toString().length && m(o, 7, t.toString()))),
        2 > (e = (n = d.toString()).length))
      )
        throw Error("The string supplied is too short to be a phone number");
      if (17 < e)
        throw Error("The string supplied is too long to be a phone number");
      if (1 < n.length && "0" == n.charAt(0)) {
        for (m(o, 4, !0), e = 1; e < n.length - 1 && "0" == n.charAt(e); ) e++;
        1 != e && m(o, 8, e);
      }
      return m(o, 2, parseInt(n, 10)), o;
    }
    function we(e, d) {
      return !(
        !(e = "string" == typeof e ? d.match("^(?:" + e + ")$") : d.match(e)) ||
        e[0].length != d.length
      );
    }
    d("intlTelInputUtils", {}),
      d("intlTelInputUtils.formatNumber", (e, d, t) => {
        try {
          const i = _.g(),
            o = be(i, e, d);
          var n = ye(i, o);
          return 0 == n || 4 == n ? re(i, o, void 0 === t ? 0 : t) : e;
        } catch (d) {
          return e;
        }
      }),
      d("intlTelInputUtils.getExampleNumber", (e, d, t) => {
        try {
          const r = _.g();
          e: {
            var n = r;
      ...
      d("intlTelInputUtils.getExtension", (e, d) => {
        try {
          return h(be(_.g(), e, d), 3);
        } catch (e) {
          return "";
        }
      }),
      d("intlTelInputUtils.getNumberType", (e, d) => {
        try {
          const r = _.g();
          var t = be(r, e, d),
            n = fe((e = r), t),
      ...
      d("intlTelInputUtils.getValidationError", (e, d) => {
        try {
          const t = _.g();
          return ye(t, be(t, e, d));
        } catch (e) {
      ...
      d("intlTelInputUtils.isValidNumber", (e, d) => {
        try {
          const c = _.g();
          var t,
            n = be(c, e, d),
          ...
          if (!(t = null == r)) {
            ...
            if ((s = "001" != i)) {
              var a = $e(e, i);
              if (null == a) throw Error("Invalid region code: " + i);
              s = o != g(a, 10);
            }
            t = s;
          }
  ...
  (function (e, d) {
    ...
    var d = {
        ...
        preStringTyped: function (e, d) {},
        onStringTyped: function (e, d) {},
        onLastStringBackspaced: function (e) {},
        onTypingPaused: function (e, d) {},
        onTypingResumed: function (e, d) {},
        onReset: function (e) {},
        onStop: function (e, d) {},
      ...
      t = new ((function () {
        ...
        return (
          (n.load = function (t, n, i) {
            if (
              ((t.el = "string" == typeof i ? document.querySelector(i) : i),
              (t.options = e({}, d, n)),
              ...
              (t.isPaused = !1),
              (t.strings = t.options.strings.map(function (e) {
                return e.trim();
              })),
              (t.stringsElement =
              ...
              if (r)
                for (var s = 0; s < r; s += 1)
                  t.strings.push(o[s].innerHTML.trim());
            }
          ...
          (n.getCurrentElContent = function (e) {
            return e.attr
          ...
          (n.appendCursorAnimationCss = function (e) {
            var d = "data-typed-js-cursor-css";
            if (e.showCursor && !document.querySelector("[" + d + "]")) {
          ...
          (n.appendFadeOutAnimationCss = function (e) {
            var d = "data-typed-fadeout-js-css";
            if (e.fadeOut && !document.querySelector("[" + d + "]")) {
              var t = document.createElement("style");
              t.setAttribute(d, "true"),
                (t.innerHTML =
      ...
      n = new ((function () {
        ...
        var d = e.prototype;
        return (
          (d.typeHtmlChars = function (e, d, t) {
            if ("html" !== t.contentType) return d;
            var n = e.substring(d).charAt(0);
            if ("<" === n || "&" === n) {
              var i;
              for (
                i = "<" === n ? ">" : ";";
                e.substring(d + 1).charAt(0) !== i && !(1 + ++d > e.length);
          ...
          (d.backSpaceHtmlChars = function (e, d, t) {
            if ("html" !== t.contentType) return d;
            var n = e.substring(d).charAt(0);
            if (">" === n || ";" === n) {
              var i;
              for (
                i = ">" === n ? "<" : "&";
                e.substring(d - 1).charAt(0) !== i && !(--d < 0);
    ...
    return (function () {
      ...
      return (
        ...
        (d.typewrite = function (e, d) {
          ...
          !0 !== this.pause.status
            ? (this.timeout = setTimeout(function () {
                d = n.typeHtmlChars(e, d, t);
                var i = 0,
                  r = e.substring(d);
                if ("^" === r.charAt(0) && /^\^\d+/.test(r)) {
                  var s = 1;
                  (s += (r = /\d+/.exec(r)[0]).length),
                    (i = parseInt(r)),
                    (t.temporaryPause = !0),
                    t.options.onTypingPaused(t.arrayPos, t),
                    (e = e.substring(0, d) + e.substring(d + s)),
                    t.toggleBlinking(!0);
                }
                if ("`" === r.charAt(0)) {
                  for (
                    ;
                    "`" !== e.substring(d + o).charAt(0) &&
                    (o++, !(d + o > e.length));

                  );
                  var a = e.substring(0, d),
                    l = e.substring(a.length + 1, d + o),
                    c = e.substring(d + o + 1);
                  (e = a + l + c), o--;
                }
                t.timeout = setTimeout(function () {
                  t.toggleBlinking(!1),
                    d >= e.length ? t.doneTyping(e, d) : t.keepTyping(e, d, o),
                    t.temporaryPause &&
                      ((t.temporaryPause = !1),
                      t.options.onTypingResumed(t.arrayPos, t));
                }, i);
              }, i))
            : this.setPauseStatus(e, d, !0);
        }),
        (d.keepTyping = function (e, d, t) {
          0 === d &&
            (this.toggleBlinking(!1),
            this.options.preStringTyped(this.arrayPos, this));
          var n = e.substring(0, (d += t));
          this.replaceText(n), this.typewrite(e, d);
        }),
        (d.doneTyping = function (e, d) {
          var t = this;
        ...
        (d.backspace = function (e, d) {
          ...
          if (!0 !== this.pause.status) {
            ...
            this.timeout = setTimeout(function () {
              d = n.backSpaceHtmlChars(e, d, t);
              var i = e.substring(0, d);
              if ((t.replaceText(i), t.smartBackspace)) {
                var o = t.strings[t.arrayPos + 1];
                t.stopNum = o && i === o.substring(0, d) ? d : 0;
              }
              d > t.stopNum
                ? (d--, t.backspace(e, d))
                : d <= t.stopNum &&
                  (t.arrayPos++,
                  t.arrayPos === t.strings.length
                    ? ((t.arrayPos = 0),
                      t.options.onLastStringBackspaced(),
                      t.shuffleStringsIfNeeded(),
                      t.begin())
                    : t.typewrite(t.strings[t.sequence[t.arrayPos]], d));
            }, i);
          } else this.setPauseStatus(e, d, !1);
        }),
        (d.complete = function () {
          this.options.onComplete(this),
            this.loop ? this.curLoop++ : (this.typingComplete = !0);
        }),
        (d.setPauseStatus = function (e, d, t) {
          (this.pause.typewrite = t),
            (this.pause.curString = e),
            (this.pause.curStrPos = d);
        }),
        (d.toggleBlinking = function (e) {
          this.cursor &&
            (this.pause.status ||
        ...
        (d.humanizer = function (e) {
          return Math.round((Math.random() * e) / 2) + e;
        }),
        (d.shuffleStringsIfNeeded = function () {
          this.shuffle &&
            (this.sequence = this.sequence.sort(function () {
              return Math.random() - 0.5;
            }));
        }),
        (d.initFadeOut = function () {
          var e = this;
          return (
        ...
        (d.bindFocusEvents = function () {
          var e = this;
          this.isInput &&
            (this.el.addEventListener("focus", function (d) {
              e.stop();
            }),
            this.el.addEventListener("blur", function (d) {
              (e.el.value && 0 !== e.el.value.length) || e.start();
            }));
        }),
        (d.insertCursor = function () {
          this.showCursor &&
            (this.cursor ||
...
const popupBtns = document.querySelectorAll(".open__popup"),
  popupBtn = document.querySelectorAll(".open__popup-2"),
  body = document.querySelector("body"),
  lockPadding = document.querySelectorAll(".lock-padding"),
  popups = document.querySelectorAll(".popup"),
  popupss = document.querySelectorAll(".popup.form"),
  popupBoxes = document.querySelectorAll(".popup__box"),
  closeButtons = document.querySelectorAll(".popup__btn, .close__btn"),
  closeButton = document.querySelectorAll(".close__btn"),
  popupBtnn = document.querySelectorAll(".popup__btn-2");
let unlock = !0;
const timeout = 300;
function bodyLock() {
  const e =
    window.innerWidth - document.querySelector(".wrapper").offsetWidth + "px";
  for (let d = 0; d < lockPadding.length; d++) {
    lockPadding[d].style.paddingRight = e;
  }
  ...
  setTimeout(function () {
    if (lockPadding.length > 0)
      for (let e = 0; e < lockPadding.length; e++) {
        lockPadding[e].style.paddingRight = "";
      }
...
popupBtnn.forEach(function (e) {
  e.addEventListener("click", function (e) {
    e.preventDefault(),
      popups.forEach(function (e) {
        e.classList.add("active"), e.classList.remove("ass");
      }),
      popupBoxes.forEach(function (e) {
        e.classList.add("active"), e.classList.remove("ass");
      }),
      popups.forEach(function (e) {
  ...
  closeButtons.forEach(function (e) {
    e.addEventListener("click", function (e) {
      e.preventDefault(),
        popups.forEach(function (e) {
          e.classList.remove("active"), e.classList.add("ass");
        }),
        popupBoxes.forEach(function (e) {
          e.classList.remove("active"), e.classList.add("ass");
        }),
  ...
  $(".table-mobile__inner").slick({
    responsive: [
      { breakpoint: 9048, settings: "unslick" },
      {
        breakpoint: 800,
        settings: {
          arrows: !1,
  ...
  $(document).ready(function () {
    ...
    function d() {
      const e = $(this).text(),
        d = $(this).closest(".select");
      d.find(".select__curent").text(e), d.removeClass("active");
    }
    $(".top__form").submit(function (e) {
      ...
      $(".header__burger").click(function () {
        $(this).toggleClass("disabled"),
          ...
          $(".header__inner").toggleClass("menu"),
          $(".wrapper").toggleClass("menu-open");
      }),
      $(".header__burger-acordeon").click(function () {
        const e = $(".header__burger-acordeon").index(this);
        $(this).toggleClass("open"),
          $(".header__burger-img-arrow").eq(e).toggleClass("open");
      }),
      $(".select__header").click(e),
      $(".select__item").click(d);
  }),
...
window.intlTelInput(input, { initialCountry: "ua" });
input = document.querySelector("#phone-2");
window.intlTelInput(input, { initialCountry: "ua" });
var top = document.querySelector("#phone-3");
window.intlTelInput(top, { initialCountry: "ua" });
top = document.querySelector("#phone-4");
window.intlTelInput(top, { initialCountry: "ua" });
var element = document.querySelector(".iti__selected-flag");
element.addEventListener("mouseenter", function () {
  event.stopPropagation(), element.classList.add("hover-effect");
}),
  element.addEventListener("mouseleave", function () {
    element.classList.remove("hover-effect");
  });
const Star = document.querySelector(".popup-input"),
  redStar = document.querySelector(".red-star");
...
const Stars = document.querySelector(".input-tel"),
  redStars = document.querySelector(".red-star-2");
function onEntry(e) {
  e.forEach((e) => {
...
$(document).ready(function () {
  $("a.header__link[href='#contact']").on("click", function (e) {
    e.preventDefault();
...
const contact = document.querySelector(".contact__input-name"),
  redStarContact = document.querySelector(".contact__red-star");
...
const contacts = document.querySelector(".contact__input-tel"),
  redStarContacts = document.querySelector(".contact__red-star-2");
contacts.addEventListener("input", function () {
  ...
  $(document).ready(function () {
    const e = $(".design-acardeon__wrapper");
    e.not(":first").find(".design-acardeon__text-box").slideUp(0),
      e.not(":first").removeClass("active"),
      e
        .not(":first")
      ...
      $(".design-acardeon").on(
        "click",
        ".design-acardeon__button",
        function () {
          const d = $(this).parent();
          d.hasClass("active")
            ? (d.removeClass("active"),
              d.find(".design-acardeon__text-box").slideUp(300),
              d
                .find(".design-acardeon__arrow")
                .css("transform", "rotate(0deg)"))
            : (e.removeClass("active"),
              e.find(".design-acardeon__text-box").slideUp(300),
              e
                .find(".design-acardeon__arrow")
                .css("transform", "rotate(0deg)"),
              d.addClass("active"),
              d.find(".design-acardeon__text-box").slideDown(300),
              d
                .find(".design-acardeon__arrow")
...
function toggleCard(e) {
  ...
  activeCard === d
    ? (d.classList.remove("active"), (activeCard = null))
...
cardElements.forEach((e) => {
  ...
  document.addEventListener("click", function (e) {
    e.target.closest(".cards__card") ||
      (activeCard &&
        (activeCard.classList.remove("active"), (activeCard = null)));
  });
...
function handleScroll() {
  ...
  prevScrollPos > e
    ...
    : e > 100 && header.classList.add("header--hidden"),
    (prevScrollPos = e);
}
...
const images = document.querySelectorAll("img"),
  callback = (e, d) => {
    e.forEach((e) => {
      e.isIntersecting &&
        (e.target.classList.add("fade-in"), d.unobserve(e.target));
    });
  },
  option = { threshold: 0.7 },
  observ = new IntersectionObserver(callback, option);
images.forEach((e) => observ.observe(e));
